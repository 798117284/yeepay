...
class SelfSettleQueryResponseDto implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'detailList' => '\Yeepay\Yop\Sdk\Service\Settle\Model\SelfSettleQueryDetailDto[]'
    ];
     ...
     * Sets code
     *
     * @param string $code <p>成功：000000<br />其他错误码参加错误码描述</p>
     *
     * @return $this
     */
     ...
     *
     * @param float $settlableAmount <p>商户可结算但未结算的金额</p>
     *
     * @return $this
     */
     ...
     *
     * @param float $unsettledAmount <p>未结算金额=可结算但未结算的金额+不可结算金额（未到结算周期的交易汇总金额）</p>
     *
     * @return $this
     */
     ...
     * Gets detailList
     *
     * @return \Yeepay\Yop\Sdk\Service\Settle\Model\SelfSettleQueryDetailDto[]
     */
     ...
     * Sets detailList
     *
     * @param \Yeepay\Yop\Sdk\Service\Settle\Model\SelfSettleQueryDetailDto[] $detailList detailList
     *
     * @return $this
     */
