...
class SettleRecordQueryDto implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'realAmount' => 'float',
        'realFee' => 'float',
        'settleDateCfg' => 'string',
        'summaryOrderAmount' => 'float',
        'summaryOrderFee' => 'float',
    ...
    protected static $swaggerFormats = [
        ...
        'realFee' => null,
        'settleDateCfg' => null,
        'summaryOrderAmount' => null,
        'summaryOrderFee' => null,
    ...
    protected static $attributeMap = [
        ...
        'realFee' => 'realFee',
        'settleDateCfg' => 'settleDateCfg',
        'summaryOrderAmount' => 'summaryOrderAmount',
        'summaryOrderFee' => 'summaryOrderFee',
    ...
    protected static $setters = [
        ...
        'realFee' => 'setRealFee',
        'settleDateCfg' => 'setSettleDateCfg',
        'summaryOrderAmount' => 'setSummaryOrderAmount',
        'summaryOrderFee' => 'setSummaryOrderFee',
    ...
    protected static $getters = [
        ...
        'realFee' => 'getRealFee',
        'settleDateCfg' => 'getSettleDateCfg',
        'summaryOrderAmount' => 'getSummaryOrderAmount',
        'summaryOrderFee' => 'getSummaryOrderFee',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['settleDateCfg'] = isset($data['settleDateCfg']) ? $data['settleDateCfg'] : null;
        $this->container['summaryOrderAmount'] = isset($data['summaryOrderAmount']) ? $data['summaryOrderAmount'] : null;
        $this->container['summaryOrderFee'] = isset($data['summaryOrderFee']) ? $data['summaryOrderFee'] : null;
     ...
     * Sets summaryNo
     *
     * @param string $summaryNo summaryNo
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status <div> <pre>SUCCESS:结算成功</pre> <div> <pre>BEFORE_REMIT:待出款</pre> <div> <pre>SETTLE_FAIL:结算异常</pre> <div> <pre>REMITTING:银行处理中</pre> </div> </div> </div> </div>
     *
     * @return $this
     */
     ...
     * @return string
     */
    public function getSettleDateCfg()
    {
        return $this->container['settleDateCfg'];
    }

    /**
     * Sets settleDateCfg
     *
     * @param string $settleDateCfg settleDateCfg
     *
     * @return $this
     */
    public function setSettleDateCfg($settleDateCfg)
    {
        $this->container['settleDateCfg'] = $settleDateCfg;

        return $this;
    }

    /**
     * Gets summaryOrderAmount
     *
     * @return float
     */
    public function getSummaryOrderAmount()
    {
        return $this->container['summaryOrderAmount'];
    }

    /**
     * Sets summaryOrderAmount
     *
     * @param float $summaryOrderAmount summaryOrderAmount
     *
     * @return $this
     */
    public function setSummaryOrderAmount($summaryOrderAmount)
    {
        $this->container['summaryOrderAmount'] = $summaryOrderAmount;

        return $this;
    }

    /**
     * Gets summaryOrderFee
     *
     * @return float
     */
    public function getSummaryOrderFee()
    {
        return $this->container['summaryOrderFee'];
    }

    /**
     * Sets summaryOrderFee
     *
     * @param float $summaryOrderFee summaryOrderFee
     *
     * @return $this
     */
    public function setSummaryOrderFee($summaryOrderFee)
    {
        $this->container['summaryOrderFee'] = $summaryOrderFee;
