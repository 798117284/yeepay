...
class AuthClientBuilder
{
    ...
    public static function __init()
    {
        ...
        self::$authorizationReqRegistry->register('eNTERPRISE_AUTH', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        self::$authorizationReqRegistry->register('enterpriseAuth', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        ...
        self::$authorizationReqRegistry->register('personQuery', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
    }
