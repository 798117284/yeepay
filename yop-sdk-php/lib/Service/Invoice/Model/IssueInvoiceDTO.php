...
/**
 * IssueInvoiceDTO Class Doc Comment
 *
 * @category Class
 * @description 发票第二版IssueInvoiceDTO
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IssueInvoiceDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IssueInvoiceDTO';
     ...
     * Sets totalPriceTax
     *
     * @param float $totalPriceTax <p>异步返参，字段类型及长度：decimal(10,2)</p>
     *
     * @return $this
     */
     ...
     * Sets invoiceStatus
     *
     * @param string $invoiceStatus <p>异步返参<br />可选项如下:<br />WAIT_REVIEW:待复核<br />UNDERWAY:开票中<br />SUCCESS:已成功<br />FAIL:已失败<br />CORRECT:已冲红<br />WAIT_INVOICE:待开票<br />RELATED:已关联</p>
     *
     * @return $this
     */
     ...
     * Sets isExpress
     *
     * @param string $isExpress <p>异步返参<br />可选项如下:<br />WAIT_MAILED:待邮寄<br />MAILED:已邮寄<br />NOTMAILED:未邮寄</p>
     *
     * @return $this
     */
     ...
     * Sets pdfUrl
     *
     * @param string $pdfUrl <p>已开发票url，异步返参</p>
     *
     * @return $this
     */
     ...
     * Sets pdfUrlCh
     *
     * @param string $pdfUrlCh <p>冲红发票url，异步返参</p>
     *
     * @return $this
     */
     ...
     * Sets log
     *
     * @param string $log <p>异步返参（只有在取消开票的时候异步返参才会有值）</p>
     *
     * @return $this
     */
     ...
     * Sets expressCompany
     *
     * @param string $expressCompany <p>异步返参</p>
     *
     * @return $this
     */
     ...
     * Sets expressNumber
     *
     * @param string $expressNumber <p>异步返参</p>
     *
     * @return $this
     */
