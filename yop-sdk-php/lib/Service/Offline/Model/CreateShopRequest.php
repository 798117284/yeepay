...
class CreateShopRequest extends \Yeepay\Yop\Sdk\Model\BaseRequest
{
    ...
    /**
     * Gets customizeShopNo
     *
     * @return string
     */
    public function getCustomizeShopNo()
    {
        return $this->customizeShopNo;
    }

    /**
     * Sets customizeShopNo
     *
     * @param string $customizeShopNo
     * @return CreateShopRequest
     */
    public function setCustomizeShopNo($customizeShopNo)
    {
        $this->customizeShopNo = $customizeShopNo;
        return $this;
    }
    /**
     * Gets realShop
