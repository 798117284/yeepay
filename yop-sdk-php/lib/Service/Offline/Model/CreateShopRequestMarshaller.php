...
class CreateShopRequestMarshaller implements RequestMarshaller
{
    ...
    public function marshal($request)
    {
        ...
        if($request->getCustomizeShopNo() != null){
            $internalRequest->addParameter('customizeShopNo', ObjectSerializer::sanitizeForSerialization($request->getCustomizeShopNo(), 'string'));
        }
        if($request->getRealShop() != null){
            $internalRequest->addParameter('realShop', ObjectSerializer::sanitizeForSerialization($request->getRealShop(), 'bool'));
        }
