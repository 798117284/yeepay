...
class QueryAccountInfoRequestMarshaller implements RequestMarshaller
{
    /**
     * @var QueryAccountInfoRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new QueryAccountInfoRequestMarshaller();
    }

    /**
     * @return QueryAccountInfoRequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v1.0/aggpay/query-account-info';
    ...
    /**
     * @param QueryAccountInfoRequest $request
     * @return Request
     */
...
QueryAccountInfoRequestMarshaller::__init();
