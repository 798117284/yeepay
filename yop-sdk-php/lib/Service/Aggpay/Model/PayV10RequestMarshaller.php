...
class PayV10RequestMarshaller implements RequestMarshaller
{
    /**
     * @var PayV10RequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new PayV10RequestMarshaller();
    }

    /**
     * @return PayV10RequestMarshaller
     */
    ...
    public function marshal($request)
    {
        ...
        if($request->getScene() != null){
            $internalRequest->addParameter('scene', ObjectSerializer::sanitizeForSerialization($request->getScene(), 'string', 'enum'));
        }
        ...
        if($request->getLimitCredit() != null){
            $internalRequest->addParameter('limitCredit', ObjectSerializer::sanitizeForSerialization($request->getLimitCredit(), 'string', 'enum'));
        }
        ...
        if($request->getReceiverAccountType() != null){
            $internalRequest->addParameter('receiverAccountType', ObjectSerializer::sanitizeForSerialization($request->getReceiverAccountType(), 'string', 'enum'));
        }
...
PayV10RequestMarshaller::__init();
