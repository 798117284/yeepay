...
/**
 * WrapPrePayOrderResponseDTO Class Doc Comment
 *
 * @category Class
 * @description 响应结果
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WrapPrePayOrderResponseDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WrapPrePayOrderResponseDTO';
     ...
     * Sets code
     *
     * @param string $code <p>请求成功返回00000</p>
     *
     * @return $this
     */
     ...
     * Sets prePayTn
     *
     * @param string $prePayTn <p>预支付标识信息，使用方法请联系易宝技术支持</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $miniProgramOrgId miniProgramOrgId
     *
     * @return $this
     */
