...
class QueryRechargeResponseDTO implements ModelInterface, ArrayAccess
{
     ...
     * Sets cardNo
     *
     * @param string $cardNo 显示前6后4，中间为*
     *
     * @return $this
     */
     ...
     * Sets orderStatus
     *
     * @param string $orderStatus 可选项如下:<br>SUCCESS:充值成功<br>FAIL:充值失败
     *
     * @return $this
     */
     ...
     * Sets userFee
     *
     * @param float $userFee 当手续费不是用户承担时该字段为空
     *
     * @return $this
     */
