...
class AccountMemberDTO implements ModelInterface, ArrayAccess
{
     ...
     * Sets idCardType
     *
     * @param string $idCardType 可选项如下:<br>ID:身份证
     *
     * @return $this
     */
     ...
     * Sets sex
     *
     * @param string $sex 可选项如下:<br>MALE:男性<br>FEMALE:女性
     *
     * @return $this
     */
     ...
     * Sets address
     *
     * @param string $address 长度不少于5个汉字，不超过44个汉字。地址需详细包含省（直辖市），市，区（县）及详细地址
     *
     * @return $this
     */
     ...
     *
     * @param string $idCardBeginDate 类型为yyyy-MM-dd
     *
     * @return $this
     */
     ...
     * Sets idCardEndDate
     *
     * @param string $idCardEndDate 类型为yyyy-MM-dd(如果为长期的话传长期)
     *
     * @return $this
     */
     ...
     * Sets idImageFront
     *
     * @param string $idImageFront 上传到易宝文件存储后返回的url
     *
     * @return $this
     */
     ...
     * Sets idImageBack
     *
     * @param string $idImageBack <br>上传到易宝文件存储后返回的url
     *
     * @return $this
     */
     ...
     * Sets faceImage
     *
     * @param string $faceImage 上传到易宝文件存储后返回的url
     *
     * @return $this
     */
     ...
     * Sets bankNo
     *
     * @param string $bankNo <a href=\"../../attachments/access?fileId=U0BjgGgqbA\">《支持的银行》</a>
     *
     * @return $this
     */
