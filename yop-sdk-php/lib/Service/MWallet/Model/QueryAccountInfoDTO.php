...
/**
 * QueryAccountInfoDTO Class Doc Comment
 *
 * @category Class
 * @description 账户信息
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class QueryAccountInfoDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'QueryAccountInfoDTO';
     ...
     * Sets accountStatus
     *
     * @param string $accountStatus 可选项如下:<br>UNACTIVED:未激活<br>USED:在用<br>FREEZE:冻结—止收止付<br>FREEZECOLLECT:冻结-止收<br>FREEZEPAY:冻结-止付<br>CANCELED:销户（账户注销了不能再用了)<br>SLEEPED:睡眠（长期无交易，不可用)
     *
     * @return $this
     */
     ...
     * Sets balance
     *
     * @param float $balance 账户余额（如果账户销户，此字段为空）
     *
     * @return $this
     */
     ...
     *
     * @param string $bankAccountLevel 账户等级（一类户，二类户，三类户)<br>可选项如下:<br>ONEACCOUNT:一类户<br>TWOACCOUNT:二类户<br>THREEACCOUNT:三类户
     *
     * @return $this
     */
