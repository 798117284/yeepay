...
class BillDetailResponseDto implements ModelInterface, ArrayAccess
{
     ...
     * Sets createTime
     *
     * @param string $createTime <p>（yyyy-MM-dd HH:mm:ss）</p>
     *
     * @return $this
     */
     ...
     * Sets orderType
     *
     * @param string $orderType 可选项如下: WITHDRAW:提现 RECHARGE:充值 PAYMENT:支付 DIVIDE:分账 DIVIDE_REFUND:分账退回 REFUND:退款 PAYMENT_MANAGE:管理费 BONUS:红包
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status 可选项如下: PROCESSING:处理中 SUCCESS:成功 FAIL:失败
     *
     * @return $this
     */
