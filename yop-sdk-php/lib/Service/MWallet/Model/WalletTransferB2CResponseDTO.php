...
class WalletTransferB2CResponseDTO implements ModelInterface, ArrayAccess
{
     ...
     * Sets status
     *
     * @param string $status <p>请求状态<br />可选项如下:<br />REQUEST_RECEIVE:请求已接收(易宝正在处理中，请勿重复下单)&nbsp; &nbsp;<br />FAIL:失败(该笔订单转账失败,可重新发起转账)</p>
     *
     * @return $this
     */
     ...
     * Sets requestNo
     *
     * @param string $requestNo <p>商户请求流水号</p>
     *
     * @return $this
     */
     ...
     * Sets orderNo
     *
     * @param string $orderNo <p>易宝统一订单号</p>
     *
     * @return $this
     */
     ...
     * Sets orderAmount
     *
     * @param string $orderAmount <p>转账订单金额</p>
     *
     * @return $this
     */
