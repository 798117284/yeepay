...
/**
 * DivideRecordRespPageDTO Class Doc Comment
 *
 * @category Class
 * @description 分账数据
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DivideRecordRespPageDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DivideRecordRespPageDTO';
     ...
     * Sets code
     *
     * @param string $code <p>返回码 OPR00000表示成功</p>
     *
     * @return $this
     */
     ...
     * Sets message
     *
     * @param string $message <p>返回信息 结果信息描述</p>
     *
     * @return $this
     */
     ...
     * Sets divideType
     *
     * @param string $divideType <p>DIVIDE：分账 BACK：分账退回</p>
     *
     * @return $this
     */
