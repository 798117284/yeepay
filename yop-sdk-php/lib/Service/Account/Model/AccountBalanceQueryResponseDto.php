...
/**
 * AccountBalanceQueryResponseDto Class Doc Comment
 *
 * @category Class
 * @description 响应结果
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AccountBalanceQueryResponseDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccountBalanceQueryResponseDto';
     ...
     * Sets returnCode
     *
     * @param string $returnCode <p>该参数代表本次请求的处理结果</p>
     *
     * @return $this
     */
     ...
     * Sets returnMsg
     *
     * @param string $returnMsg <p>信息描述，对应returnCode的中文信息</p>
     *
     * @return $this
     */
     ...
     * Sets merchantNo
     *
     * @param string $merchantNo <p>记账簿所属的商户编号</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $merchantAccountBookName <p>商户侧记账簿名称</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $ypAccountBookNo <p>易宝记账薄编号</p>
     *
     * @return $this
     */
     ...
     * Sets balance
     *
     * @param float $balance 单位元，精确到两位小数
     *
     * @return $this
     */
     ...
     * Sets freezeBalance
     *
     * @param float $freezeBalance 单位元，精确到两位小数
     *
     * @return $this
     */
     ...
     *
     * @param string $accountBookType <p>记账簿类型<br />BUSINESS 企业<br />PERSON 个人</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $certificateType <p>证件类型类型<br />BIZ_LICENSEES 统一信信用代码<br />ID_CARD 身份证</p>
     *
     * @return $this
     */
     ...
     * Sets bindCardList
     *
     * @param \Yeepay\Yop\Sdk\Service\Account\Model\BindCardDTO[] $bindCardList <p>绑卡信息</p>
     *
     * @return $this
     */
