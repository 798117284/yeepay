...
class ReceiverInfoDTO implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $receiverBankCode <div data-page-id=\"PLAKdsGpEoESzGxHKQpc140lnxf\" data-lark-html-role=\"root\" data-docx-has-block-data=\"false\"> <div class=\" old-record-id-IqOjdQM3log3TmxiwIcc0E13nfQ\">收款方银行卡对应的开户行的总行编码(对公账户类型，总行编码/支行编码不能同时为空)，详见 <a href=\"https://yeepay.feishu.cn/sheets/MmMfsrTbnhn744tjYdEcvoNmn83?sheet=Cn65To\" data-lark-is-custom=\"true\">【总行及支行明细】</a></div> </div>
     *
     * @return $this
     */
     ...
     * Sets branchBankCode
     *
     * @param string $branchBankCode <div data-page-id=\"PLAKdsGpEoESzGxHKQpc140lnxf\" data-lark-html-role=\"root\" data-docx-has-block-data=\"false\"> <div class=\" old-record-id-R7KOdfZRaomewLxtQowcSmqNntf\">支行编码(对公账户类型，总行编码/支行编码不能同时为空) 详见<a href=\"https://yeepay.feishu.cn/sheets/MmMfsrTbnhn744tjYdEcvoNmn83?sheet=0Smsnm\" data-lark-is-custom=\"true\">《支行编码》</a>中的支行行号</div> </div>
     *
     * @return $this
     */
