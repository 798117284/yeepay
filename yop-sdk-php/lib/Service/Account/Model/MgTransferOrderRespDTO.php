...
/**
 * MgTransferOrderRespDTO Class Doc Comment
 *
 * @category Class
 * @description 转账查询相应结果
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MgTransferOrderRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MgTransferOrderRespDTO';
     ...
     * Sets transferStatus
     *
     * @param string $transferStatus 可选项如下: REQUEST_RECEIVE:请求已接收(易宝正在处理中，请勿重复下单) SUCCESS:转账成功 FAIL:失败(该笔订单转账失败，请更换商户请求号后重新发起转账) WAIT_AUDIT:已受理,待复核
     *
     * @return $this
     */
     ...
     * Sets orderNo
     *
     * @param string $orderNo <p>易宝内部系统生成的唯一订单号</p>
     *
     * @return $this
     */
