...
/**
 * ReceiverReceiptResponseDTO Class Doc Comment
 *
 * @category Class
 * @description 获取接收方回单-响应
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReceiverReceiptResponseDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReceiverReceiptResponseDTO';
     ...
     * Sets fileType
     *
     * @param string $fileType 可选项如下: pdf:pdf文件
     *
     * @return $this
     */
