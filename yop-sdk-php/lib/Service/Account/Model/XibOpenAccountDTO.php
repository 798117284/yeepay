...
class XibOpenAccountDTO implements ModelInterface, ArrayAccess
{
    ...
    const BIND_CARD_TYPE_CARD = 'PUBLIC_CARD';
     ...
     * @return string[]
     */
    public function getBindCardTypeAllowableValues()
    {
        return [
            self::BIND_CARD_TYPE_CARD,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getBindCardTypeAllowableValues();
        if (!is_null($this->container['bindCardType']) && !in_array($this->container['bindCardType'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'bindCardType', must be one of '%s'",
     ...
     * Sets mobileNo
     *
     * @param string $mobileNo <p>该手机号用于接收银行打款验资的验证码，请务必谨慎填写</p>
     *
     * @return $this
     */
     ...
     * Sets bindCardType
     *
     * @param string $bindCardType 可选项如下: PUBLIC_CARD:对公卡
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getBindCardTypeAllowableValues();
        if (!in_array($bindCardType, $allowedValues, true)) {
     ...
     * Sets returnUrl
     *
     * @param string $returnUrl <p>页面跳转地址</p>
     *
     * @return $this
     */
     ...
     * Sets legalGender
     *
     * @param string $legalGender 可选项如下: MALE:男 FEMALE:女
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getLegalGenderAllowableValues();
        if (!is_null($legalGender) && !in_array($legalGender, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'legalGender', must be one of '%s'",
                    implode("', '", $allowedValues)
    ...
    {
        $allowedValues = $this->getBenefitCertificateTypeAllowableValues();
        if (!is_null($benefitCertificateType) && !in_array($benefitCertificateType, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'benefitCertificateType', must be one of '%s'",
                    implode("', '", $allowedValues)
