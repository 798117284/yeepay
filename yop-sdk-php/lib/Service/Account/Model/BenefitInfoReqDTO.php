...
class BenefitInfoReqDTO implements ModelInterface, ArrayAccess
{
     ...
     * Sets benefitIdType
     *
     * @param string $benefitIdType 可选项如下:<br>ID_CARD:身份证
     *
     * @return $this
     */
     ...
     * Sets benefitIdNo
     *
     * @param string $benefitIdNo 填写身份证号码
     *
     * @return $this
     */
     ...
     *
     * @param string $benefitStartDate 参数格式为yyyyMMdd
     *
     * @return $this
     */
     ...
     *
     * @param string $benefitExpireDate 参数格式为yyyyMMdd或者forever
     *
     * @return $this
     */
     ...
     *
     * @param string $benefitIncomeType 可选项如下:<br>A01:直接或间接控股25%（含）以上<br>A02:通过人事、财务等其他方式对公司进行控制<br>A03:高级管理人员<br>A04:法人或公司负责人<br>A05:其他
     *
     * @return $this
     */
