...
class HtbOpenAccountDTO implements ModelInterface, ArrayAccess
{
    ...
    const SHAREHOLDER_CERTIFICATE_TYPE_CARD = 'ID_CARD';
    const BENEFIT_CERTIFICATE_TYPE_CARD = 'ID_CARD';
     ...
     * @return string[]
     */
    public function getShareholderCertificateTypeAllowableValues()
    {
        return [
            self::SHAREHOLDER_CERTIFICATE_TYPE_CARD,
        ];
    }
     ...
     * @return string[]
     */
    public function getBenefitCertificateTypeAllowableValues()
    {
        return [
            self::BENEFIT_CERTIFICATE_TYPE_CARD,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getShareholderCertificateTypeAllowableValues();
        if (!is_null($this->container['shareholderCertificateType']) && !in_array($this->container['shareholderCertificateType'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'shareholderCertificateType', must be one of '%s'",
        ...
        $allowedValues = $this->getBenefitCertificateTypeAllowableValues();
        if (!is_null($this->container['benefitCertificateType']) && !in_array($this->container['benefitCertificateType'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'benefitCertificateType', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
     ...
     *
     * @param string $businessLicenceEffectiveDate <p>格式:yyyyMMdd</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $businessLicenceExpirationDate <p>格式:yyyyMMdd<br />长期有效:forever</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $enterpriseEmail <p>企业邮箱</p>
     *
     * @return $this
     */
     ...
     * Sets mobileNo
     *
     * @param string $mobileNo <p>经办人手机号</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $legalLicenceEffectiveDate <p>格式:yyyyMMdd</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $legalLicenceExpirationDate <p>格式:yyyyMMdd<br />长期有效:forever</p>
     *
     * @return $this
     */
     ...
     * Sets legalMobileNo
     *
     * @param string $legalMobileNo <p>法人手机号</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $shareholderName <p>股东或实际控制人姓名</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $shareholderCertificateType 可选项如下: ID_CARD:身份证
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getShareholderCertificateTypeAllowableValues();
        if (!in_array($shareholderCertificateType, $allowedValues, true)) {
     ...
     *
     * @param string $shareholderCertificateNo <p>股东或实际控制人证件号</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $shareholderEffectiveDate <p>格式:yyyyMMdd</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $shareholderExpirationDate <p>格式:yyyyMMdd<br />长期有效:forever</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $shareholderMobileNo <p>股东或实际控制人手机号</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $benefitCertificateType 可选项如下: ID_CARD:身份证
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getBenefitCertificateTypeAllowableValues();
        if (!in_array($benefitCertificateType, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'benefitCertificateType', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     *
     * @param string $benefitCertificateNo <p>受益人证件号</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $benefitEffectiveDate <p>格式:yyyyMMdd</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $benefitExpirationDate <p>格式:yyyyMMdd<br />长期有效:forever</p>
     *
     * @return $this
     */
     ...
     * Sets benefitAddress
     *
     * @param string $benefitAddress <p>受益人住址</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $registerProvince <p>详见<a href=\"../attachments/access?fileId=Vgl7WwDQsC\">《省市区编码》</a></p>
     *
     * @return $this
     */
     ...
     * Sets registerCity
     *
     * @param string $registerCity <p>详见<br /><a href=\"../attachments/access?fileId=Vgl7WwDQsC\">《省市区编码》</a></p>
     *
     * @return $this
     */
     ...
     *
     * @param string $registerDistinct <p>详见<br /><a href=\"../attachments/access?fileId=Vgl7WwDQsC\">《省市区编码》</a></p>
     *
     * @return $this
     */
