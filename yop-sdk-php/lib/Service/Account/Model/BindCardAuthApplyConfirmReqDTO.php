...
/**
 * BindCardAuthApplyConfirmReqDTO Class Doc Comment
 *
 * @category Class
 * @description 请修改我
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BindCardAuthApplyConfirmReqDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BindCardAuthApplyConfirmReqDTO';
     ...
     *
     * @param string $businessOrderNo <p>易宝唯一流水号</p>
     *
     * @return $this
     */
     ...
     * Sets authCode
     *
     * @param string $authCode <p>银行认证信息<br />短信验证：填写验证码</p> <p>打款验证：填写打款金额</p>
     *
     * @return $this
     */
