...
class AutoWithdrawRuleSetV10RequestMarshaller implements RequestMarshaller
{
    /**
     * @var AutoWithdrawRuleSetV10RequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new AutoWithdrawRuleSetV10RequestMarshaller();
    }

    /**
     * @return AutoWithdrawRuleSetV10RequestMarshaller
     */
    ...
    /**
     * @param AutoWithdrawRuleSetV10Request $request
     * @return Request
     */
    public function marshal($request)
    {
        ...
        if($request->getNotifyAddress() != null){
            $internalRequest->addParameter('notifyAddress', ObjectSerializer::sanitizeForSerialization($request->getNotifyAddress(), 'string'));
        }
...
AutoWithdrawRuleSetV10RequestMarshaller::__init();
