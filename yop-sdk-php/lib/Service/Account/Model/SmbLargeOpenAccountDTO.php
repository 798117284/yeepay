...
class SmbLargeOpenAccountDTO implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $businessLicenceEffectiveDate <p>格式为yyyyMMdd</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $businessLicenceExpirationDate <p>格式为yyyyMMdd，forever</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $legalLicenceEffectiveDate <p>格式为yyyyMMdd</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $legalLicenceExpirationDate <p>格式为yyyyMMdd，forever</p>
     *
     * @return $this
     */
