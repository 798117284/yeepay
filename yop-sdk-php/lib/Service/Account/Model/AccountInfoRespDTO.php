...
/**
 * AccountInfoRespDTO Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AccountInfoRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccountInfoRespDTO';
     ...
     * Sets returnCode
     *
     * @param string $returnCode 返回码<br>该参数代表本次请求的处理结果，UA00000为请求成功 若请求失败参看对应错误码和错误信息
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $accountCreateTime 
     *
     * @return $this
     */
     ...
     * Sets accountStatus
     *
     * @param string $accountStatus 账户状态<br>AVAILABLE：可用（账户状态可用，可使用余额进行交易）FROZEN：冻结（账户状态不可用，请勿发起交易）FROZEN_CREDIT：冻结止收（当前账户请勿发起资金入账交易）FROZEN_DEBIT：冻结止付（当前账户状态下请勿发起资金出款交易）
     *
     * @return $this
     */
