...
/**
 * SubBankAccountBindCardRespDTO Class Doc Comment
 *
 * @category Class
 * @description 缴费账户绑卡响应结果
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SubBankAccountBindCardRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SubBankAccountBindCardRespDTO';
     ...
     * Sets returnCode
     *
     * @param string $returnCode <p>返回码 该参数代表本次请求的处理结果，AM00000为请求成功 若请求失败参看对应错误码和错误信息 &nbsp;</p>
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status 可选项如下: SUCCESS:成功 FAIL:失败
     *
     * @return $this
     */
