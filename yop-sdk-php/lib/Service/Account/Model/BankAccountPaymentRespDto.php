...
/**
 * BankAccountPaymentRespDto Class Doc Comment
 *
 * @category Class
 * @description 响应结果
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BankAccountPaymentRespDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BankAccountPaymentRespDto';
     ...
     * Sets code
     *
     * @param string $code <p>响应编码.<br />UA00000 成功<br />UA00001 系统异常<br />其他错误码参考错误码列表</p>
     *
     * @return $this
     */
     ...
     * Sets message
     *
     * @param string $message <p>返回描述信息,可参考此信息判断请求失败原因.</p>
     *
     * @return $this
     */
     ...
     * Sets uniqueOrderNo
     *
     * @param string $uniqueOrderNo <p>易宝唯一订单号<br />成功时返回</p>
     *
     * @return $this
     */
     ...
     * Sets orderId
     *
     * @param string $orderId <p>商户订单号,同入参<br />成功时返回</p>
     *
     * @return $this
     */
     ...
     * Sets orderStatus
     *
     * @param string $orderStatus <p>订单状态-成功时返回可选项如下:<br />ACCEPT:已受理<br />PROCESSING:处理中<br />SUCCESS:成功(本接口未异步接口,同步不会返回此状态)<br />FAIL:失败</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $paymentUniqueOrderNo <p>支付订单号</p>
     *
     * @return $this
     */
