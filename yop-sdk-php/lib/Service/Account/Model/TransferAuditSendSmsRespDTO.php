...
/**
 * TransferAuditSendSmsRespDTO Class Doc Comment
 *
 * @category Class
 * @description 请修改我
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TransferAuditSendSmsRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TransferAuditSendSmsRespDTO';
     ...
     * @return string[]
     */
    public function getSendStatusAllowableValues()
    {
        return [
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getSendStatusAllowableValues();
        if (!is_null($this->container['sendStatus']) && !in_array($this->container['sendStatus'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'sendStatus', must be one of '%s'",
     ...
     * Sets sendStatus
     *
     * @param string $sendStatus 可选项如下: SUCCESS:发送成功
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getSendStatusAllowableValues();
        if (!is_null($sendStatus) && !in_array($sendStatus, $allowedValues, true)) {
