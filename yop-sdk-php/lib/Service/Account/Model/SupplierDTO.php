...
class SupplierDTO implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['supplierId'] === null) {
            $invalidProperties[] = "'supplierId' can't be null";
        }
     ...
     * Sets supplierId
     *
     * @param int $supplierId <p>供应商id</p>
     *
     * @return $this
     */
     ...
     * Sets supplierType
     *
     * @param string $supplierType <p>可选项如下:<br />PERSON:个人<br />BUSINESS:企业</p>
     *
     * @return $this
     */
     ...
     * Sets supplierName
     *
     * @param string $supplierName <p>功能供应商名称</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $supplierQualLicenceNo <p>供应商资质编码</p>
     *
     * @return $this
     */
     ...
     * Sets createTime
     *
     * @param \DateTime $createTime <p>供应商创建时间</p>
     *
     * @return $this
     */
