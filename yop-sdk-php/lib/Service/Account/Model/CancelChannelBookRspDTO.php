...
/**
 * CancelChannelBookRspDTO Class Doc Comment
 *
 * @category Class
 * @description 转账到支付宝解约响应参数
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CancelChannelBookRspDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CancelChannelBookRspDTO';
     ...
     * Sets status
     *
     * @param string $status <p>状态<br />PROCESS(\"进行中\"),<br />FAIL(\"失败\"),<br />SUCCESS(\"成功\"),<br />CANCEL_PROCESS(\"解约进行中\"),<br />CANCEL(\"解约\"),</p>
     *
     * @return $this
     */
