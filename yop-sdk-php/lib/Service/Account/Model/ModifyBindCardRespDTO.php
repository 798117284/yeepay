...
/**
 * ModifyBindCardRespDTO Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ModifyBindCardRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModifyBindCardRespDTO';
     ...
     * Sets returnCode
     *
     * @param string $returnCode 返回码该参数代表本次请求的处理结果，若请求失败参看对应错误码和错误信息
     *
     * @return $this
     */
