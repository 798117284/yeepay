...
/**
 * SignContractApplyQueryRspDTO Class Doc Comment
 *
 * @category Class
 * @description 请修改我
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SignContractApplyQueryRspDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SignContractApplyQueryRspDTO';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['contractUrl'] = isset($data['contractUrl']) ? $data['contractUrl'] : null;
    ...
    {
        return $this->container['contractUrl'];
    }

    /**
     * Sets contractUrl
     *
     * @param string $contractUrl <p>支付宝签约链接&nbsp; 状态处理中返回</p>
     *
     * @return $this
     */
    public function setContractUrl($contractUrl)
    {
        $this->container['contractUrl'] = $contractUrl;
     ...
     * Sets status
     *
     * @param string $status <p>状态</p> <p>PROCESS(\"进行中\"),<br />FAIL(\"失败\"),<br />SUCCESS(\"成功\"),<br />CANCEL_PROCESS(\"解约进行中\"),<br />CANCEL(\"解约\");</p>
     *
     * @return $this
     */
