...
/**
 * WithdrawOrderRespDTO Class Doc Comment
 *
 * @category Class
 * @description 提现下单响应结果
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WithdrawOrderRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WithdrawOrderRespDTO';
     ...
     * Sets status
     *
     * @param string $status <p>订单状态<br />可选项如下:<br />REQUEST_RECEIVE:请求已接收（易宝正在处理中，收到最终结果前请勿重复下单）<br />REQUEST_ACCEPT:请求已受理（易宝正在处理中，收到最终结果前请勿重复下单）<br />FAIL:失败<br />REMITING:（银行正在处理中，收到最终结果前请勿重复下单）</p>
     *
     * @return $this
     */
     ...
     * Sets orderNo
     *
     * @param string $orderNo <p>易宝提现订单号<br />易宝支付系统生成的提现订单号</p>
     *
     * @return $this
     */
