...
class AccountTradeRequestDTO implements ModelInterface, ArrayAccess
{
     ...
     * Sets terminalType
     *
     * @param string $terminalType <p><br /><br /></p> 可选项如下: PC:电脑 PHONE:手机 PAD:平板 NFC:可穿戴设备 DTV:数字电视 MPOS:条码支付受理终端 OTHER:其他
     *
     * @return $this
     */
     ...
     * Sets notifyUrl
     *
     * @param string $notifyUrl <p>不传则不通知</p>
     *
     * @return $this
     */
     ...
     * Sets comments
     *
     * @param string $comments <div data-lark-html-role=\"root\"><span class=\"text-only\">展示在收款银行系统中的附言，由数字、字母、汉字组成（最终附言内容以银行实际账单为准）；不同收款行对附言长度限制不同，建议控制在32字符内</span></div>
     *
     * @return $this
     */
     ...
     * Sets riskInfo
     *
     * @param string $riskInfo <p>透传风控标识json格式（<span class=\"text-only\">该</span><span class=\"text-only text-with-abbreviation text-with-abbreviation-bottomline\">字段</span><span class=\"text-only\">仅限未来云平台商交易模式使用，其他业务无须</span><span class=\"text-only text-with-abbreviation text-with-abbreviation-bottomline\">传参</span>）<br />replaceMerchantNo:代付方易宝商编<br />replaceName:代付方名称<br />jobType:职位类型<br />格式如下：{\"replaceMerchantNo\": \"\", \"replaceName\": \"\",\"jobType\": \"\"}</p>
     *
     * @return $this
     */
