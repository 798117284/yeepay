...
/**
 * XibMultiBindCardRspDTO Class Doc Comment
 *
 * @category Class
 * @description 请修改我
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class XibMultiBindCardRspDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'XibMultiBindCardRspDTO';
     ...
     * Sets returnCode
     *
     * @param string $returnCode <pre>成功：UA00000</pre> <p>&nbsp;</p>
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status <div class=\"api-desc-wrap\"> <p>绑卡状态<br />INIT：初始化<br />PROCESS：处理中<br />SUCCESS：成功<br />FAIL：失败<br /><br /></p> </div> <div>示例值：SUCCESS</div>
     *
     * @return $this
     */
