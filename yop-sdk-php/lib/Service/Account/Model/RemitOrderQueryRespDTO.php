...
/**
 * RemitOrderQueryRespDTO Class Doc Comment
 *
 * @category Class
 * @description 付款查询
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RemitOrderQueryRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RemitOrderQueryRespDTO';
     ...
     * Sets receiveAmount
     *
     * @param float $receiveAmount 到账金额<br>返回收款银行账户入账金额
     *
     * @return $this
     */
     ...
     * Sets debitAmount
     *
     * @param float $debitAmount 扣账金额<br>返回易宝账户扣账金额（包含付款金额和手续费（若有））
     *
     * @return $this
     */
     ...
     * Sets orderTime
     *
     * @param \DateTime $orderTime 付款下单时间<br>返回易宝接收付款请求后创建订单时间
     *
     * @return $this
     */
     ...
     * Sets finishTime
     *
     * @param \DateTime $finishTime 付款完成时间 <br>返回付款订单有明确结果（如订单状态为SUCCESS/FAIL）时的时间
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status <p>订单状态<br />可选项如下:<br />REQUEST_RECEIVE:请求已接收（易宝正在处理中，收到最终结果前请勿重复下单）<br />REQUEST_ACCEPT:请求已受理（易宝正在处理中，收到最终结果前请勿重复下单）<br />SUCCESS:已到账<br />REMITING:银行处理中（银行正在处理中，收到最终结果前请勿重复下单）<br />FAIL:失败（该笔订单付款失败,可重新发起付款）<br />CANCELED:订单已撤销</p>
     *
     * @return $this
     */
     ...
     * Sets failCode
     *
     * @param string $failCode <p>所查询的订单的错误码</p> <p>失败错误码，当付款失败时，会返回失败错误码</p>
     *
     * @return $this
     */
     ...
     * Sets failReason
     *
     * @param string $failReason <p>所查询的订单的失败原因</p> <p>当付款失败时，会返回失败原因</p>
     *
     * @return $this
     */
     ...
     * Sets receiveType
     *
     * @param string $receiveType <p>到账类型<br />可选项如下:<br />REAL_TIME:实时<br />TWO_HOUR:2小时到账<br />NEXT_DAY:次日到账（无特殊情况资金于次日上午7点左右到收款银行账户中）</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $receiverAccountNo <p>收款方银行账号<br />返回收款账户-银行账号</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $receiverAccountName <p>收款方开户名<br />返回收款账户-开户名称</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $receiverBankCode <p>收款方开户行编码<br />返回收款账户-开户行编码</p>
     *
     * @return $this
     */
     ...
     * Sets branchBankCode
     *
     * @param string $branchBankCode <p>支行编码, 也叫做联行号</p>
     *
     * @return $this
     */
     ...
     * Sets isReversed
     *
     * @param bool $isReversed 冲退标识<br>由于银行原因，会发生付款已到账又通知冲退的情况（付款资金会原路退回到商户账户）
     *
     * @return $this
     */
     ...
     * Sets reverseTime
     *
     * @param \DateTime $reverseTime 冲退时间<br>返回银行通知冲退时的时间
     *
     * @return $this
     */
     ...
     * Sets bankOrderNo
     *
     * @param string $bankOrderNo <p>请求银网联侧的银行订单号</p>
     *
     * @return $this
     */
