...
/**
 * PayResultResponseDTO Class Doc Comment
 *
 * @category Class
 * @description 响应结果
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PayResultResponseDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PayResultResponseDTO';
     ...
     * Sets status
     *
     * @param string $status SUCCESS—交易成功<br>FAIL—支付失败<br>TIME_OUT—订单超时过期
     *
     * @return $this
     */
