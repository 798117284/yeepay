...
class InstallmentPayRequestV11RequestMarshaller implements RequestMarshaller
{
    ...
    public function marshal($request)
    {
        ...
        if($request->getPid() != null){
            $internalRequest->addParameter('pid', ObjectSerializer::sanitizeForSerialization($request->getPid(), 'string'));
        }
        if($request->getTrxChnnel() != null){
            $internalRequest->addParameter('trxChnnel', ObjectSerializer::sanitizeForSerialization($request->getTrxChnnel(), 'string'));
        }
