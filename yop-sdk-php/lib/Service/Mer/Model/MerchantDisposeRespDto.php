...
/**
 * MerchantDisposeRespDto Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MerchantDisposeRespDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MerchantDisposeRespDto';
     ...
     * Sets bizStatus
     *
     * @param string $bizStatus 申请单状态可选项如下:<br>REVIEWING:申请审核中<br>REVIEW_BACK:申请已驳回<br>COMPLETE:申请已完成
     *
     * @return $this
     */
