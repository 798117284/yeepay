...
class MerchantInfoModifyV10RequestMarshaller implements RequestMarshaller
{
    /**
     * @var MerchantInfoModifyV10RequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new MerchantInfoModifyV10RequestMarshaller();
    }

    /**
     * @return MerchantInfoModifyV10RequestMarshaller
     */
    ...
    /**
     * @param MerchantInfoModifyV10Request $request
     * @return Request
     */
    public function marshal($request)
    {
        ...
        if($request->getQualificationInfo() != null){
            $internalRequest->addParameter('qualificationInfo', ObjectSerializer::sanitizeForSerialization($request->getQualificationInfo(), 'string'));
        }
        if($request->getMerchantReportConfig() != null){
            $internalRequest->addParameter('merchantReportConfig', ObjectSerializer::sanitizeForSerialization($request->getMerchantReportConfig(), 'string'));
        }
        ...
        if($request->getSettleConfig() != null){
            $internalRequest->addParameter('settleConfig', ObjectSerializer::sanitizeForSerialization($request->getSettleConfig(), 'string'));
        }
...
MerchantInfoModifyV10RequestMarshaller::__init();
