...
class BindcardQueryorderRequest extends \Yeepay\Yop\Sdk\Model\BaseRequest
{
    ...
    /**
     * Gets cardInfoEncryptType
     *
     * @return string
     */
    public function getCardInfoEncryptType()
    {
        return $this->cardInfoEncryptType;
    }

    /**
     * Sets cardInfoEncryptType
     *
     * @param string $cardInfoEncryptType
     * @return BindcardQueryorderRequest
     */
    public function setCardInfoEncryptType($cardInfoEncryptType)
    {
        $this->cardInfoEncryptType = $cardInfoEncryptType;
        return $this;
    }
