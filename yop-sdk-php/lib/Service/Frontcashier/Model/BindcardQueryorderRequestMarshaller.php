...
class BindcardQueryorderRequestMarshaller implements RequestMarshaller
{
    ...
    public function marshal($request)
    {
        ...
        if($request->getCardInfoEncryptType() != null){
            $internalRequest->addParameter('cardInfoEncryptType', ObjectSerializer::sanitizeForSerialization($request->getCardInfoEncryptType(), 'string'));
        }
