...
class BindcardBindcardlistRequestMarshaller implements RequestMarshaller
{
    /**
     * @var BindcardBindcardlistRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new BindcardBindcardlistRequestMarshaller();
    }

    /**
     * @return BindcardBindcardlistRequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v1.0/frontcashier/bindcard/bindcardlist';
    ...
    /**
     * @param BindcardBindcardlistRequest $request
     * @return Request
     */
...
BindcardBindcardlistRequestMarshaller::__init();
