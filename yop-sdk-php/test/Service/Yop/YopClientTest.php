...
class YopClientTest extends TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$client = YopClientBuilder::builder($sdkConfigFile)->build();
        ...
        //self::$client = YopClientBuilder::builder(new AppSdkConfig(\GuzzleHttp\json_decode($sdkConfigJson, true)))->build();
    }

    /**
     * YOP报备临时公钥(/rest/v1.0/yop/oauth2/report-key)
     *
     * @test
     */
