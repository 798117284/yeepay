...
class SysClientTest extends TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$client = SysClientBuilder::builder($sdkConfigFile)->build();
        ...
        //self::$client = SysClientBuilder::builder(new AppSdkConfig(\GuzzleHttp\json_decode($sdkConfigJson, true)))->build();
    }

    /**
     * 子商户入网资质文件上传(/yos/v1.0/sys/merchant/qual/upload)
     *
     * @test
     */
