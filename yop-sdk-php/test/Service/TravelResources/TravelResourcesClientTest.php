...
class TravelResourcesClientTest extends TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$client = TravelResourcesClientBuilder::builder($sdkConfigFile)->build();
        ...
        //self::$client = TravelResourcesClientBuilder::builder(new AppSdkConfig(\GuzzleHttp\json_decode($sdkConfigJson, true)))->build();
    }

    /**
     * 创建电影票订单(/rest/v1.0/travel-resources/create-order)
     *
     * @test
     */
    ...
    /**
     * 创建KFC订单(/rest/v1.0/travel-resources/kfc-order)
     *
     * @test
     */
    ...
    /**
     * 查询电影票订单(/rest/v1.0/travel-resources/query-cinema-order)
     *
     * @test
     */
    ...
    /**
     * 查询KFC订单(/rest/v1.0/travel-resources/query-kfc-order)
     *
     * @test
     */
