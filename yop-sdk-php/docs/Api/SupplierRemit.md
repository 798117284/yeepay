...
[**bill_download_v1_0**](SupplierRemit.md#bill_download_v1_0) | **GET** /yos/v1.0/supplier-remit/bill/download | 付款对账文件获取接口
...
# **bill_download_v1_0**
YosDownloadResponse bill_download_v1_0(BillDownloadV10Request request)
...
$api_client = Yeepay\Yop\Sdk\Service\SupplierRemit\SupplierRemitClientBuilder::builder()->build();
$request = new Yeepay\Yop\Sdk\Service\SupplierRemit\Model\BillDownloadV10Request();
$request->setRemitDate("remitDate_example");

try {
    $response = $api_client->bill_download_v1_0($request);
    $response->save('targetFilePath');
}catch (\Exception $e) {
