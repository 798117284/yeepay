...
**transferStatus** | **string** | 可选项如下: REQUEST_RECEIVE:请求已接收(易宝正在处理中,收到最终结果前请勿重复下单) SUCCESS:转账成功 FAIL:失败(该笔订单转账失败,可重新发起转账) WAIT_AUDIT:已受理,待复核 AUDIT_REFUSED:复核拒绝 AUDIT_PASS:复核通过 | [optional] 
