# ApplyAddAuditorReqDTO

## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**auditBiz** | **string** | &lt;p&gt;REMIT: 付款&lt;/p&gt; &lt;p&gt;TRANSFER: 转账&lt;/p&gt; | [optional] 
...
**auditorDetails** | [**\Yeepay\Yop\Sdk\Service\Account\Model\AuditorDetailReqDTO[]**](AuditorDetailReqDTO.md) | &lt;p&gt;短验复核人列表&lt;/p&gt; | 
