...
**createTime** | **string** | &lt;p&gt;（yyyy-MM-dd HH:mm:ss）&lt;/p&gt; | [optional] 
**requestNo** | **string** | &lt;p&gt;商户请求号&lt;/p&gt; | [optional] 
**uniqueOrderNo** | **string** | &lt;p&gt;易宝唯一订单号&lt;/p&gt; | [optional] 
**orderType** | **string** | 可选项如下: WITHDRAW:提现 RECHARGE:充值 PAYMENT:支付 DIVIDE:分账 DIVIDE_REFUND:分账退回 REFUND:退款 PAYMENT_MANAGE:管理费 BONUS:红包 | 
**status** | **string** | 可选项如下: PROCESSING:处理中 SUCCESS:成功 FAIL:失败 | 
