...
------------- | ------------- | -------------
[**accountConfirm**](Frontcashier.md#accountConfirm) | **POST** /rest/v1.0/frontcashier/account-confirm | 到账信息确认接口
[**accountInfoConfirm**](Frontcashier.md#accountInfoConfirm) | **POST** /rest/v1.0/frontcashier/account-confirm | 到账信息确认接口
...
[**bankTransferPayV1_1**](Frontcashier.md#bankTransferPayV1_1) | **POST** /rest/v1.1/frontcashier/bank-transfer/pay | 银行转账支付
[**bankTransferQuery**](Frontcashier.md#bankTransferQuery) | **GET** /rest/v1.0/frontcashier/bank-transfer/query | 银行转账查询
[**bank_transfer_pay_v1_1**](Frontcashier.md#bank_transfer_pay_v1_1) | **POST** /rest/v1.1/frontcashier/bank-transfer/pay | 银行转账支付
[**bindcardBindcardlist**](Frontcashier.md#bindcardBindcardlist) | **POST** /rest/v1.0/frontcashier/bindcard/bindcardlist | 查询签约/绑卡列表
...
[**bindcardRequestV2_2**](Frontcashier.md#bindcardRequestV2_2) | **POST** /rest/v2.2/frontcashier/bindcard/request | 中台绑卡-绑卡请求（支持接口、跳页签约）
[**bindcardResendsms**](Frontcashier.md#bindcardResendsms) | **POST** /rest/v1.0/frontcashier/bindcard/resendsms | 绑卡-短验重发
...
[**bindcard_request_v2_2**](Frontcashier.md#bindcard_request_v2_2) | **POST** /rest/v2.2/frontcashier/bindcard/request | 中台绑卡-绑卡请求（支持接口、跳页签约）
...
[**upopActivescanVccPay**](Frontcashier.md#upopActivescanVccPay) | **POST** /rest/v1.0/frontcashier/upop/activescan/vcc/pay | 付款方虚拟卡主扫下单
[**upopPassivescanBindQrcode**](Frontcashier.md#upopPassivescanBindQrcode) | **POST** /rest/v1.0/frontcashier/upop/passivescan/bind/qrcode | 付款方被扫申码
...
[**upopPassivescanVccQrcode**](Frontcashier.md#upopPassivescanVccQrcode) | **POST** /rest/v1.0/frontcashier/upop/passivescan/vcc/qrcode | 付款方被扫虚拟卡申码
[**upop_activescan_vcc**](Frontcashier.md#upop_activescan_vcc) | **POST** /rest/v1.0/frontcashier/upop/activescan/vcc/pay | 付款方虚拟卡主扫下单
[**upop_passivescan_vcc**](Frontcashier.md#upop_passivescan_vcc) | **POST** /rest/v1.0/frontcashier/upop/passivescan/vcc/qrcode | 付款方被扫虚拟卡申码
...
# **accountConfirm**
AccountConfirmResponse accountConfirm(AccountConfirmRequest request)
...
$request = new Yeepay\Yop\Sdk\Service\Frontcashier\Model\AccountConfirmRequest();
$request->setBody(new \Yeepay\Yop\Sdk\Service\Frontcashier\Model\APIOfflineTransferAccountInfoConfirmRequestDTO());

try {
    $response = $api_client->accountConfirm($request);
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Yeepay\Yop\Sdk\Service\Frontcashier\Model\APIOfflineTransferAccountInfoConfirmRequestDTO**](../Model/APIOfflineTransferAccountInfoConfirmRequestDTO.md)|  | [optional]

### Return type
[**\Yeepay\Yop\Sdk\Service\Frontcashier\Model\APIOfflineTransferAccountInfoConfirmResponseDTO**](../Model/APIOfflineTransferAccountInfoConfirmResponseDTO.md)
### Authorization
...
# **accountInfoConfirm**
AccountInfoConfirmResponse accountInfoConfirm(AccountInfoConfirmRequest request)
...
$api_client = Yeepay\Yop\Sdk\Service\Frontcashier\FrontcashierClientBuilder::builder()->build();
$request = new Yeepay\Yop\Sdk\Service\Frontcashier\Model\AccountInfoConfirmRequest();
$request->setBody(new \Yeepay\Yop\Sdk\Service\Frontcashier\Model\APIOfflineTransferAccountInfoConfirmRequestDTO());

try {
    $response = $api_client->accountInfoConfirm($request);
    print_r($response->getResult());
}catch (\Exception $e) {
 ...
 **accountNotifyUrl** | **string**|  | [optional]
...
# **bankTransferPayV1_1**
BankTransferPayV11Response bankTransferPayV1_1(BankTransferPayV11Request request)
...
$api_client = Yeepay\Yop\Sdk\Service\Frontcashier\FrontcashierClientBuilder::builder()->build();
$request = new Yeepay\Yop\Sdk\Service\Frontcashier\Model\BankTransferPayV11Request();
$request->setParentMerchantNo("parentMerchantNo_example");
$request->setMerchantNo("merchantNo_example");
$request->setOrderId("orderId_example");
$request->setOrderAmount(1.2);
...
try {
    $response = $api_client->bankTransferPayV1_1($request);
    print_r($response->getResult());
}catch (\Exception $e) {
...
### Return type
[**\Yeepay\Yop\Sdk\Service\Frontcashier\Model\APIOfflineTransferResponseDTO**](../Model/APIOfflineTransferResponseDTO.md)
### Authorization
...
# **bank_transfer_pay_v1_1**
BankTransferPayV11Response bank_transfer_pay_v1_1(BankTransferPayV11Request request)
...
try {
    $response = $api_client->bank_transfer_pay_v1_1($request);
    print_r($response->getResult());
}catch (\Exception $e) {
...
# **bindcardBindcardlist**
BindcardBindcardlistResponse bindcardBindcardlist(BindcardBindcardlistRequest request)
...
$api_client = Yeepay\Yop\Sdk\Service\Frontcashier\FrontcashierClientBuilder::builder()->build();
$request = new Yeepay\Yop\Sdk\Service\Frontcashier\Model\BindcardBindcardlistRequest();
...
try {
    $response = $api_client->bindcardBindcardlist($request);
    print_r($response->getResult());
}catch (\Exception $e) {
...
### Return type
[**\Yeepay\Yop\Sdk\Service\Frontcashier\Model\BindcardBindcardlistQueryBindCardResponseDTOResult**](../Model/BindcardBindcardlistQueryBindCardResponseDTOResult.md)
### Authorization
 ...
 **phone** | **string**|  | [optional]
 **cardInfoEncryptType** | **string**|  | [optional]
...
# **bindcardRequestV2_2**
BindcardRequestV22Response bindcardRequestV2_2(BindcardRequestV22Request request)
...
$api_client = Yeepay\Yop\Sdk\Service\Frontcashier\FrontcashierClientBuilder::builder()->build();
$request = new Yeepay\Yop\Sdk\Service\Frontcashier\Model\BindcardRequestV22Request();
$request->setBody(new \Yeepay\Yop\Sdk\Service\Frontcashier\Model\AgreementBindCardRequestDTO());

try {
    $response = $api_client->bindcardRequestV2_2($request);
    print_r($response->getResult());
}catch (\Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Yeepay\Yop\Sdk\Service\Frontcashier\Model\AgreementBindCardRequestDTO**](../Model/AgreementBindCardRequestDTO.md)|  | [optional]

### Return type
[**\Yeepay\Yop\Sdk\Service\Frontcashier\Model\AgreementBindCardResponseDTO**](../Model/AgreementBindCardResponseDTO.md)
### Authorization
...
# **bindcardResendsms**
BindcardResendsmsResponse bindcardResendsms(BindcardResendsmsRequest request)
...
$api_client = Yeepay\Yop\Sdk\Service\Frontcashier\FrontcashierClientBuilder::builder()->build();
$request = new Yeepay\Yop\Sdk\Service\Frontcashier\Model\BindcardResendsmsRequest();
$request->setParentMerchantNo("parentMerchantNo_example");
$request->setMerchantNo("merchantNo_example");
$request->setMerchantFlowId("merchantFlowId_example");

try {
    $response = $api_client->bindcardResendsms($request);
    print_r($response->getResult());
}catch (\Exception $e) {
...
### Return type
[**\Yeepay\Yop\Sdk\Service\Frontcashier\Model\BindcardResendsmsOpenAuthBindCardSmsResponseDTOResult**](../Model/BindcardResendsmsOpenAuthBindCardSmsResponseDTOResult.md)
### Authorization
...
# **bindcard_request_v2_2**
BindcardRequestV22Response bindcard_request_v2_2(BindcardRequestV22Request request)
...
try {
    $response = $api_client->bindcard_request_v2_2($request);
    print_r($response->getResult());
}catch (\Exception $e) {
...
# **upopActivescanVccPay**
UpopActivescanVccPayResponse upopActivescanVccPay(UpopActivescanVccPayRequest request)
...
$api_client = Yeepay\Yop\Sdk\Service\Frontcashier\FrontcashierClientBuilder::builder()->build();
$request = new Yeepay\Yop\Sdk\Service\Frontcashier\Model\UpopActivescanVccPayRequest();
$request->setMerchantFlowId("merchantFlowId_example");
...
try {
    $response = $api_client->upopActivescanVccPay($request);
    print_r($response->getResult());
}catch (\Exception $e) {
 ...
 **deviceSimNumber** | **string**|  | [optional]
 **deviceName** | **string**|  | [optional]
 **riskInfoMobile** | **string**|  | [optional]

### Return type
[**\Yeepay\Yop\Sdk\Service\Frontcashier\Model\OpenActiveScanPayResponseDTO**](../Model/OpenActiveScanPayResponseDTO.md)
### Authorization
...
# **upopPassivescanBindQrcode**
UpopPassivescanBindQrcodeResponse upopPassivescanBindQrcode(UpopPassivescanBindQrcodeRequest request)
...
$api_client = Yeepay\Yop\Sdk\Service\Frontcashier\FrontcashierClientBuilder::builder()->build();
$request = new Yeepay\Yop\Sdk\Service\Frontcashier\Model\UpopPassivescanBindQrcodeRequest();
$request->setMerchantFlowId("merchantFlowId_example");
...
try {
    $response = $api_client->upopPassivescanBindQrcode($request);
    print_r($response->getResult());
}catch (\Exception $e) {
...
------------- | ------------- | ------------- | -------------
 **merchantFlowId** | **string**|  | [optional]
 **pinFreeAmount** | **float**|  | [optional]
 **maxAmont** | **float**|  | [optional]
 **notifyUrl** | **string**|  | [optional]
 **validNotifyUrl** | **string**|  | [optional]
...
### Return type
[**\Yeepay\Yop\Sdk\Service\Frontcashier\Model\UpopPassivescanBindQrcodeOpenPassiveScanPayResponseDTOResult**](../Model/UpopPassivescanBindQrcodeOpenPassiveScanPayResponseDTOResult.md)
### Authorization
...
# **upopPassivescanVccQrcode**
UpopPassivescanVccQrcodeResponse upopPassivescanVccQrcode(UpopPassivescanVccQrcodeRequest request)
...
$api_client = Yeepay\Yop\Sdk\Service\Frontcashier\FrontcashierClientBuilder::builder()->build();
$request = new Yeepay\Yop\Sdk\Service\Frontcashier\Model\UpopPassivescanVccQrcodeRequest();
$request->setMerchantFlowId("merchantFlowId_example");
$request->setCardNo("cardNo_example");
$request->setCvv("cvv_example");
$request->setValid("valid_example");
...
try {
    $response = $api_client->upopPassivescanVccQrcode($request);
    print_r($response->getResult());
}catch (\Exception $e) {
 ...
 **sourceIP** | **string**|  | [optional]
 **riskInfoMobile** | **string**|  | [optional]
 **usrRgstrDt** | **\DateTime**|  | [optional]

### Return type
[**\Yeepay\Yop\Sdk\Service\Frontcashier\Model\OpenPassiveScanPayResponseDTO**](../Model/OpenPassiveScanPayResponseDTO.md)
### Authorization
...
# **upop_activescan_vcc**
UpopActivescanVccResponse upop_activescan_vcc(UpopActivescanVccRequest request)
...
$api_client = Yeepay\Yop\Sdk\Service\Frontcashier\FrontcashierClientBuilder::builder()->build();
$request = new Yeepay\Yop\Sdk\Service\Frontcashier\Model\UpopActivescanVccRequest();
$request->setMerchantFlowId("merchantFlowId_example");
$request->setCardNo("cardNo_example");
$request->setCvv("cvv_example");
$request->setValid("valid_example");
...
try {
    $response = $api_client->upop_activescan_vcc($request);
    print_r($response->getResult());
}catch (\Exception $e) {
...
# **upop_passivescan_vcc**
UpopPassivescanVccResponse upop_passivescan_vcc(UpopPassivescanVccRequest request)
...
$api_client = Yeepay\Yop\Sdk\Service\Frontcashier\FrontcashierClientBuilder::builder()->build();
$request = new Yeepay\Yop\Sdk\Service\Frontcashier\Model\UpopPassivescanVccRequest();
$request->setMerchantFlowId("merchantFlowId_example");
$request->setCardNo("cardNo_example");
$request->setCvv("cvv_example");
$request->setValid("valid_example");
...
try {
    $response = $api_client->upop_passivescan_vcc($request);
    print_r($response->getResult());
}catch (\Exception $e) {
