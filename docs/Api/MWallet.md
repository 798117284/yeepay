...
[**account_query_balance_v1_0**](MWallet.md#account_query_balance_v1_0) | **GET** /rest/v1.0/m-wallet/account/query-balance | 会员银行账户余额查询
 ...
 **elecAccount** | **string**| 账户号 | [optional]

### Return type
[**\Yeepay\Yop\Sdk\Service\MWallet\Model\QueryBalanceResponseDTO**](../Model/QueryBalanceResponseDTO.md)
### Authorization
...
# **account_query_balance_v1_0**
AccountQueryBalanceV10Response account_query_balance_v1_0(AccountQueryBalanceV10Request request)
...
$api_client = Yeepay\Yop\Sdk\Service\MWallet\MWalletClientBuilder::builder()->build();
$request = new Yeepay\Yop\Sdk\Service\MWallet\Model\AccountQueryBalanceV10Request();
$request->setMerchantMemberNo("merchantMemberNo_example");
$request->setParentMerchantNo("parentMerchantNo_example");
$request->setMerchantNo("merchantNo_example");
$request->setAccountType("accountType_example");
...
try {
    $response = $api_client->account_query_balance_v1_0($request);
    print_r($response->getResult());
}catch (\Exception $e) {
 ...
 **returnUrl** | **string**|  | [optional]
 **merchantNo** | **string**|  | [optional]
 **agreementAmount** | **string**|  | [optional]
 ...
 **endTime** | **string**| &lt;p&gt;yyyy-MM-dd HH:mm:ss&lt;/p&gt; |
 **orderType** | **string**| 可选项如下: WITHDRAW:提现 RECHARGE:充值 PAYMENT:支付 DIVIDE:分账 DIVIDE_REFUND:分账退回 REFUND:退款 PAYMENT_MANAGE:管理费 BONUS:红包 | [optional]
 **fundDirection** | **string**| 可选项如下: IN:入金 OUT:出金 | [optional]
 **startTime** | **string**| &lt;p&gt;不传默认为查询截止时间的当月第一天0点&lt;br /&gt;yyyy-MM-dd HH:mm:ss&lt;/p&gt; | [optional]
 ...
 **parentMerchantNo** | **string**| &lt;p&gt;业务发起方商编（标准商户收付款方案中此参数与商编一致，平台商户收付款方案中此参数为平台商商户编号）&lt;/p&gt; |
 **merchantNo** | **string**| &lt;p&gt;商户编号 易宝支付分配的的商户唯一标识&lt;/p&gt; |
 **queryType** | **string**| 可选项如下: NOT_USE:未使用 USED:已使用 EXPIRED:已过期 |
 ...
 **parentMerchantNo** | **string**| &lt;p&gt;发起方商户编号（标准商户收付款方案中此参数与商编一致，平台商户收付款方案中此参数为平台商商户编号）&lt;/p&gt; |
 **merchantNo** | **string**| &lt;p&gt;易宝支付分配的的商户唯一标识&lt;/p&gt; |
 **externalUserId** | **string**| &lt;p&gt;用户在商户侧的用户ID&lt;br /&gt;与会员号二选一必填&lt;/p&gt; | [optional]
 **memberNo** | **string**| &lt;p&gt;与商户用户ID二选一必填&lt;/p&gt; | [optional]
...
------------- | ------------- | ------------- | -------------
 **parentMerchantNo** | **string**| &lt;p&gt;发起方商户编号（标准商户收付款方案中此参数与商编一致，平台商户收付款方案中此参数为平台商商户编号）&lt;/p&gt; |
 **fromMerchantNo** | **string**| &lt;p&gt;交易主体商编(转出方商编）&lt;/p&gt; |
 **requestNo** | **string**| &lt;p&gt;与易宝订单号不能同时为空&lt;/p&gt; | [optional]
 **businessNo** | **string**| &lt;p&gt;转账发起完成后，易宝返回的唯一订单号&lt;/p&gt; | [optional]
