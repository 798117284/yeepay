...
------------ | ------------- | ------------- | -------------
**subRefundOrderDTOs** | [**\Yeepay\Yop\Sdk\Service\Trade\Model\ResponseRefundDTO[]**](ResponseRefundDTO.md) | &lt;p&gt;合单退款子单列表&lt;/p&gt; | [optional] 
**code** | **string** | &lt;p&gt;返回码&lt;/p&gt; | 
...
**parentUniqueRefundNo** | **string** | &lt;p&gt;易宝合单退款流水号&lt;/p&gt; | [optional] 
