...
**status** | **string** | 可选项如下:&lt;br&gt;SUCCESS:提现成功&lt;br&gt;FAIL:提现失败&lt;br&gt;PROCESS:提现中 | [optional] 
**finishTime** | **string** | 时间格式为：yyyy-MM-dd HH:mm:ss | [optional] 
**createTime** | **string** | 时间格式为：yyyy-MM-dd HH:mm:ss | [optional] 
