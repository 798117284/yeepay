...
class BillClientTest extends TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$client = BillClientBuilder::builder($sdkConfigFile)->build();
        ...
        //self::$client = BillClientBuilder::builder(new AppSdkConfig(\GuzzleHttp\json_decode($sdkConfigJson, true)))->build();
    }

    /**
     * 账户对账单-下载(/yos/v1.0/bill/download)
     *
     * @test
     */
