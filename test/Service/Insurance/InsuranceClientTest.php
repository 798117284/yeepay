...
class InsuranceClientTest extends TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$client = InsuranceClientBuilder::builder($sdkConfigFile)->build();
        ...
        //self::$client = InsuranceClientBuilder::builder(new AppSdkConfig(\GuzzleHttp\json_decode($sdkConfigJson, true)))->build();
    }

    /**
     * 实名缴费认证(/rest/v1.0/insurance/realname/auth)
     *
     * @test
     */
    ...
    /**
     * 交易通知(/rest/v1.0/insurance/realname/notify)
     *
     * @test
     */
