...
class RechargeClientTest extends TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$client = RechargeClientBuilder::builder($sdkConfigFile)->build();
        ...
        //self::$client = RechargeClientBuilder::builder(new AppSdkConfig(\GuzzleHttp\json_decode($sdkConfigJson, true)))->build();
    }

    /**
     * 银行账户查询余额(/rest/v1.0/recharge/bank-account/query)
     *
     * @test
     */
     ...
     * @test
     */
    public function bank_account_query_v1_0Test()
    {
        $request = new Model\BankAccountQueryV10Request();
        ...
        $request->setParentMerchantNo("parentMerchantNo_example");
        try{
            $response = self::$client->bank_account_query_v1_0($request);
            print_r($response->getResult());
        }catch (\Exception $e) {
