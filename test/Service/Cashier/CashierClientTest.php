...
class CashierClientTest extends TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$client = CashierClientBuilder::builder($sdkConfigFile)->build();
        ...
        //self::$client = CashierClientBuilder::builder(new AppSdkConfig(\GuzzleHttp\json_decode($sdkConfigJson, true)))->build();
    }

    /**
     * 生成聚合订单码(/rest/v1.0/cashier/pay-link/order)
     *
     * @test
     */
    ...
    /**
     * 收银台统一下单(/rest/v1.0/cashier/unified/order)
     *
     * @test
     */
