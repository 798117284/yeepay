...
/**
 * RechargeApiRespDTO Class Doc Comment
 *
 * @category Class
 * @description 充值查询返回结果
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RechargeApiRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RechargeApiRespDTO';
     ...
     * Sets returnCode
     *
     * @param string $returnCode 返回码<br>该参数代表本次请求的处理结果
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status 订单状态<br>可选项如下:<br>INIT:处理中<br>FAIL:充值失败
     *
     * @return $this
     */
     ...
     * Sets remitComment
     *
     * @param string $remitComment remitComment
     *
     * @return $this
     */
