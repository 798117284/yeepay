...
/**
 * WechatTransferRespDTO Class Doc Comment
 *
 * @category Class
 * @description 响应结果
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WechatTransferRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WechatTransferRespDTO';
     ...
     * Sets status
     *
     * @param string $status 可选项如下:<br>FAIL:失败<br>ACCEPT:已受理
     *
     * @return $this
     */
