...
class WhzbbOpenAccountDTO implements ModelInterface, ArrayAccess
{
    ...
    const BIND_CARD_TYPE_PUBLIC_CARD = 'PUBLIC_CARD';
    const BIND_CARD_TYPE_PRIVATE_CARD = 'PRIVATE_CARD';
    ...
    {
        return [
            self::BIND_CARD_TYPE_PUBLIC_CARD,
            self::BIND_CARD_TYPE_PRIVATE_CARD,
        ];
    }
     ...
     * Sets bindCardType
     *
     * @param string $bindCardType 可选项如下: PUBLIC_CARD:对公卡 PRIVATE_CARD:对私卡
     *
     * @return $this
     */
     ...
     *
     * @param string $bindAccountName <p>绑卡名称</p>
     *
     * @return $this
     */
     ...
     * Sets bcpNo
     *
     * @param string $bcpNo <p>基本账户开户许可核准号</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $organizationStart <p>参数格式为yyyyMMdd</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $organizationEnd <p>参数格式为yyyyMMdd或者forever</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $organizationPicUrl <p>组织机构代码证照片</p>
     *
     * @return $this
     */
     ...
     * Sets taxPicUrl
     *
     * @param string $taxPicUrl <p>税务登记证照片</p>
     *
     * @return $this
     */
