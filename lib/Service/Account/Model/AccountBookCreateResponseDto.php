...
class AccountBookCreateResponseDto implements ModelInterface, ArrayAccess
{
     ...
     * Sets merchantNo
     *
     * @param string $merchantNo <p>申请记账簿的商户编号</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $ypAccountBookNo <p>易宝记账薄编号（用于汇款时填写的收款账号）</p>
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status <p>SUCCESS:成功<br />PROCESSING:处理中,需要原参数重试<br />FAIL:处理失败</p>
     *
     * @return $this
     */
     ...
     * Sets createTime
     *
     * @param string $createTime <p>记账簿创建时间</p>
     *
     * @return $this
     */
