...
class AccountDTO implements ModelInterface, ArrayAccess
{
     ...
     * Sets accountType
     *
     * @param string $accountType <p>账户类型<br />SETTLE_ACCOUNT:待结算账户<br />FUND_ACCOUNT:商户资金账户 <br />MARKET_ACCOUNT:营销账户 <br />DIVIDE_ACCOUNT:待分账账户 <br />FEE_ACCOUNT:手续费账户<br />SPECIAL_FUND_ACCOUNT:专款账户<br />DIVIDE_FUND_ACCOUNT:分账资金账户<br />DIVIDE_PENDING_ACCOUNT:分账在途账户</p>
     *
     * @return $this
     */
     ...
     * Sets accountStatus
     *
     * @param string $accountStatus <p>可选项如下:<br />AVAILABLE:可用<br />FROZEN:冻结<br />FROZEN_CREDIT:冻结止收<br />FROZEN_DEBIT:冻结止付<br />CANCELLATION:销户</p>
     *
     * @return $this
     */
