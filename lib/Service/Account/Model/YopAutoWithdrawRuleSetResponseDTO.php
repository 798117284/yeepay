...
/**
 * YopAutoWithdrawRuleSetResponseDTO Class Doc Comment
 *
 * @category Class
 * @description 自动提现规则设置响应结果
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class YopAutoWithdrawRuleSetResponseDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'YopAutoWithdrawRuleSetResponseDTO';
