...
/**
 * RemitOrderQueryDTO Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RemitOrderQueryDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RemitOrderQueryDTO';
     ...
     * Sets requestNo
     *
     * @param string $requestNo <span style=\"color: #333333; font-family: Arial, sans-serif; text-align: center;\">商户请求号</span>
     *
     * @return $this
     */
     ...
     * Sets orderNo
     *
     * @param string $orderNo <span style=\"color: #333333; font-family: Arial, sans-serif; text-align: center;\">易宝流水号</span>
     *
     * @return $this
     */
     ...
     * Sets receiveAmount
     *
     * @param float $receiveAmount <span style=\"color: #333333; font-family: Arial, sans-serif; text-align: center;\">收款金额</span>
     *
     * @return $this
     */
     ...
     * Sets debitAmount
     *
     * @param float $debitAmount <span style=\"color: #333333; font-family: Arial, sans-serif; text-align: center;\">扣账金额</span>
     *
     * @return $this
     */
     ...
     * Sets orderTime
     *
     * @param \DateTime $orderTime <span style=\"color: #333333; font-family: Arial, sans-serif; text-align: center;\">创建时间</span>
     *
     * @return $this
     */
     ...
     *
     * @param string $feeUndertakerMerchantNo 
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status 可选项如下:<br>REQUEST_RECEIVE:请求已接收<br>REQUEST_ACCEPT:请求已受理<br>SUCCESS:成功<br>FAIL:失败<br>CANCELED:请求撤销<br>REMITING:打款中
     *
     * @return $this
     */
     ...
     * Sets receiveType
     *
     * @param string $receiveType <span style=\"color: #333333; font-family: Arial, sans-serif; text-align: center;\">付款到账类型</span><br>可选项如下:<br>REAL_TIME:实时<br>TWO_HOUR:两小时<br>NEXT_DAY:次日
     *
     * @return $this
     */
     ...
     *
     * @param string $receiverBankCode <span style=\"color: #333333; font-family: Arial, sans-serif; text-align: center;\">收款方银行编码</span>
     *
     * @return $this
     */
     ...
     * Sets comments
     *
     * @param string $comments <span style=\"color: #333333; font-family: Arial, sans-serif; text-align: center;\">银行附言</span>
     *
     * @return $this
     */
     ...
     * Sets isReversed
     *
     * @param bool $isReversed <span style=\"color: #333333; font-family: Arial, sans-serif; text-align: center;\">冲退标识，true表示是冲退，false表示未发生冲退</span>
     *
     * @return $this
     */
     ...
     * Sets reverseTime
     *
     * @param \DateTime $reverseTime 冲退时间，仅isReversed=true时有值
     *
     * @return $this
     */
