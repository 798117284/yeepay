...
/**
 * BatchReceiptRespDTO Class Doc Comment
 *
 * @category Class
 * @description 响应结果
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BatchReceiptRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BatchReceiptRespDTO';
     ...
     * Sets data
     *
     * @param string $data 返回一个base64字符串数据;（商户可通过Base64解码，将返回字符串转化为字节数组，并在本地新建以.pdf格式的文件，直接写入该pdf文件即可）
     *
     * @return $this
     */
