...
/**
 * AutoPaymentRespDto Class Doc Comment
 *
 * @category Class
 * @description 响应结果
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AutoPaymentRespDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AutoPaymentRespDto';
     ...
     * Sets code
     *
     * @param string $code 响应编码UA00000成功<br>需要结合orderStatus状态进行处理当orderStatus 为ACCEPT时需要延迟10秒后调用查询接口确认订单是否成功
     *
     * @return $this
     */
     ...
     * Sets orderStatus
     *
     * @param string $orderStatus 订单状态-成功时返回可选项如下:<br>ACCEPT:已受理<br>PROCESSING:处理中<br>SUCCESS:成功<br>FAIL:失败
     *
     * @return $this
     */
