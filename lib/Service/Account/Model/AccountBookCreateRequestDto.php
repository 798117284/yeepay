...
class AccountBookCreateRequestDto implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $merchantAccountBookNo <p>数字、字母、下划线组合</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $merchantAccountBookName <p>非必填，字符长度须小于等于50(记账簿收款使用&ldquo;记账薄预收款_银行汇款_标准版&rdquo;时，开立记账簿时必须传入&ldquo;记账簿名称&rdquo;)</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $certificateType <p>证件类型（绑卡列表不为空时，该项必填 ）</p> 可选项如下: BIZ_LICENSEES:统一信用代码 ID_CARD:身份证
     *
     * @return $this
     */
     ...
     * Sets certificateNo
     *
     * @param string $certificateNo <p>证件号（绑卡列表不为空时，该项必填 ）</p>
     *
     * @return $this
     */
