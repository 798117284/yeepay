...
class ShareHolderInfoReqDTO implements ModelInterface, ArrayAccess
{
     ...
     * Sets ownerIdType
     *
     * @param string $ownerIdType <p>可选项如下:<br />ID_CARD:身份证<br />BUSINESS_LICENCE:营业执照</p>
     *
     * @return $this
     */
     ...
     * Sets ownerIdNo
     *
     * @param string $ownerIdNo <p>填写身份证号码或营业执照号</p>
     *
     * @return $this
     */
     ...
     * Sets ownerStartDate
     *
     * @param string $ownerStartDate 参数格式为yyyyMMdd
     *
     * @return $this
     */
     ...
     *
     * @param string $ownerExpireDate 参数格式为yyyyMMdd或者forever
     *
     * @return $this
     */
