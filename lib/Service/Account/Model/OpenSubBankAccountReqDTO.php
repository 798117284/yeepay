...
class OpenSubBankAccountReqDTO implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $merchantAccountUid <p>商户侧记账簿编号，数字、字母、下划线组合</p>
     *
     * @return $this
     */
     ...
     * Sets bankAccountNo
     *
     * @param string $bankAccountNo <p>银行账户号<br />备注：对应银行开户接口中，开成功的银行账户号</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $payerAccountName <p>付款方账户名称（开通标准版产品时，该字段必填）</p>
     *
     * @return $this
     */
