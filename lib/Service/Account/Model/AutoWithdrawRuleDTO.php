...
/**
 * AutoWithdrawRuleDTO Class Doc Comment
 *
 * @category Class
 * @description 自动提现规则实体
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AutoWithdrawRuleDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AutoWithdrawRuleDTO';
     ...
     * Sets createTime
     *
     * @param \DateTime $createTime <p>规则创建时间</p>
     *
     * @return $this
     */
     ...
     * Sets merchantNo
     *
     * @param string $merchantNo <p>交易主体商编</p>
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status <p>规则状态，可选项如下:<br />EFFECTIVE: 生效<br />CANCEL:&nbsp;失效</p>
     *
     * @return $this
     */
     ...
     * Sets receiveType
     *
     * @param string $receiveType <p>提现到账类型，可选项如下:<br />REAL_TIME: 实时<br />TWO_HOUR: 两小时<br />NEXT_DAY: 次日</p>
     *
     * @return $this
     */
     ...
     * Sets bankAccountNo
     *
     * @param string $bankAccountNo <p>银行卡号</p>
     *
     * @return $this
     */
     ...
     * Sets triggerTime
     *
     * @param string $triggerTime <p>触发时间，格式： HH:mm</p>
     *
     * @return $this
     */
     ...
     * Sets remainAmount
     *
     * @param float $remainAmount 保留金额，提现发起后的账户余额
     *
     * @return $this
     */
     ...
     * Sets remark
     *
     * @param string $remark <p>银行附言 发送给银行的银行附言</p>
     *
     * @return $this
     */
