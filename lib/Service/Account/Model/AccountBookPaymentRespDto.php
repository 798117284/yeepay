...
/**
 * AccountBookPaymentRespDto Class Doc Comment
 *
 * @category Class
 * @description 响应结果
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AccountBookPaymentRespDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccountBookPaymentRespDto';
     ...
     * Sets code
     *
     * @param string $code 响应编码<br>UA00000成功，需要结合orderStatus状态进行处理<br>当orderStatus 为ACCEPT时需要延迟10秒后调用查询接口确认订单是否成功
     *
     * @return $this
     */
     ...
     * Sets orderStatus
     *
     * @param string $orderStatus 可选项如下:<br>ACCEPT:已受理（易宝正在处理中，最终结果请以支付结果回调为准）<br>SUCCESS:成功<br>FAIL:失败
     *
     * @return $this
     */
