...
/**
 * YopAppointTargetRemitResponseDTO Class Doc Comment
 *
 * @category Class
 * @description 定向付款的响应结果
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class YopAppointTargetRemitResponseDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'YopAppointTargetRemitResponseDTO';
     ...
     * Sets returnMsg
     *
     * @param string $returnMsg <p>与返回码对应的说明信息</p>
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status 可选项如下: REQUEST_RECEIVE:请求已接收（易宝正在处理中，收到最终结果前请勿重复下单） REQUEST_ACCEPT:请求已受理（易宝正在处理中，收到最终结果前请勿重复下单） REMITING:银行处理中（银行正在处理中，收到最终结果前请勿重复下单） FAIL:失败
     *
     * @return $this
     */
