...
/**
 * BankCardAccount Class Doc Comment
 *
 * @category Class
 * @description 银行卡对象
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BankCardAccount implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BankCardAccount';
    ...
    const BANK_CARD_TYPE_DEBIT_CARD = 'DEBIT_CARD';
    const BANK_CARD_TYPE_ENTERPRISE_ACCOUNT = 'ENTERPRISE_ACCOUNT';
    ...
    {
        return [
            self::BANK_CARD_TYPE_DEBIT_CARD,
            self::BANK_CARD_TYPE_ENTERPRISE_ACCOUNT,
        ];
    }
     ...
     * Sets bankCardType
     *
     * @param string $bankCardType 可选项如下: DEBIT_CARD:借记卡 ENTERPRISE_ACCOUNT:对公账户
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getBankCardTypeAllowableValues();
        if (!is_null($bankCardType) && !in_array($bankCardType, $allowedValues, true)) {
     ...
     * Sets accountName
     *
     * @param string $accountName <p>开户名:<br /><span style=\"color: #666666;\">返回商户的提现卡-开户名称</span></p>
     *
     * @return $this
     */
     ...
     * Sets bankCode
     *
     * @param string $bankCode <p>开户行编码:<br />返回商户的提现卡-开户银行编码</p>
     *
     * @return $this
     */
     ...
     * Sets accountNo
     *
     * @param string $accountNo <p>银行账号:<br /><span style=\"color: #666666;\">返回商户的提现卡-银行账号</span></p>
     *
     * @return $this
     */
     ...
     * Sets bindCardId
     *
     * @param string $bindCardId <p>银行卡标识:<br />返回易宝生成的银行卡唯一标识</p>
     *
     * @return $this
     */
     ...
     * Sets branchBankCode
     *
     * @param string $branchBankCode <p>支行行号</p>
     *
     * @return $this
     */
