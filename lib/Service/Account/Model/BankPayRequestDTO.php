...
/**
 * BankPayRequestDTO Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BankPayRequestDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BankPayRequestDTO';
     ...
     * Sets bankCode
     *
     * @param string $bankCode 银行编码.仅支付方式为BANK_PAY时必填<br>可选项如下:<br>XIB<br>BOL<br>FJHTB<br>WHZBB<br>XWB<br>HXBXB<br>SUNINGBANK<br>WHLHB
     *
     * @return $this
     */
     ...
     *
     * @param string $bankPayCertificate 银行编码为BOL的时候必填
     *
     * @return $this
     */
     ...
     * Sets userRequestIP
     *
     * @param string $userRequestIP 用户发起请求的客户端ip（银行编码为BOL的时候必填）
     *
     * @return $this
     */
     ...
     * Sets bankUsage
     *
     * @param string $bankUsage 银行用途,仅支付方式为BANK_PAY且BANK_CODE为BOL时有效<br>可选项如下:<br>TRANSFER:转账<br>REFUND:退款<br>WITHDRAW:提现
     *
     * @return $this
     */
     ...
     * Sets bankAccountNo
     *
     * @param string $bankAccountNo 银行编码为[XIB、FJHTB、WHZBB、XWB、HXBXB、SUNINGBANK、WHLHB]的时候必填
     *
     * @return $this
     */
