...
/**
 * SubBankAccountBindCardReqDTO Class Doc Comment
 *
 * @category Class
 * @description 缴费账户绑卡请求参数
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SubBankAccountBindCardReqDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SubBankAccountBindCardReqDTO';
     ...
     * Sets merchantNo
     *
     * @param string $merchantNo <p>商户编号 易宝支付分配的的商户唯一标识</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $bankAccountBookNo <p>缴费账户号 备注：对应申请缴费账户接口中，开成功的缴费账户号</p>
     *
     * @return $this
     */
