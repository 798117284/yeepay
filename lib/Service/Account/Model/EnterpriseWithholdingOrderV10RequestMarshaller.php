...
class EnterpriseWithholdingOrderV10RequestMarshaller implements RequestMarshaller
{
    /**
     * @var EnterpriseWithholdingOrderV10RequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new EnterpriseWithholdingOrderV10RequestMarshaller();
    }

    /**
     * @return EnterpriseWithholdingOrderV10RequestMarshaller
     */
    ...
    /**
     * @param EnterpriseWithholdingOrderV10Request $request
     * @return Request
     */
    public function marshal($request)
    {
        ...
        if($request->getPayerNotifyUrl() != null){
            $internalRequest->addParameter('payerNotifyUrl', ObjectSerializer::sanitizeForSerialization($request->getPayerNotifyUrl(), 'string'));
        }
...
EnterpriseWithholdingOrderV10RequestMarshaller::__init();
