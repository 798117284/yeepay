...
/**
 * RemitDetailDTO Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RemitDetailDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RemitDetailDTO';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['receiverBankCode'] === null) {
            $invalidProperties[] = "'receiverBankCode' can't be null";
        }
     ...
     * Sets requestNo
     *
     * @param string $requestNo 请求号，由商户自定义生成，需保证唯一
     *
     * @return $this
     */
     ...
     *
     * @param string $receiverBankCode 收款方开户行<br>银行卡所在开户行编号，详见<br><a href=\"https://open.yeepay.com/attachments/access?fileId=FFTv15d8TY\">总行及支行编码表</a>
     *
     * @return $this
     */
     ...
     * Sets orderAmount
     *
     * @param float $orderAmount 付款金额<br>单位：元（RMB）
     *
     * @return $this
     */
     ...
     * Sets comments
     *
     * @param string $comments 银行附言<br>展示在收款银行系统中的附言，由数字、字母、汉字组成（能否成功展示依赖银行系统支持）
     *
     * @return $this
     */
     ...
     *
     * @param string $bankAccountType 账户类型<br>可选项如下:<br>DEBIT_CARD:借记卡<br>CREDIT_CARD:贷记卡<br>QUASI_CREDIT_CARD:准贷卡<br>PASSBOOK:存折<br>UNIT_SETTLE_CARD:单位结算卡<br>PUBLIC_CARD:对公卡
     *
     * @return $this
     */
     ...
     * Sets branchBankCode
     *
     * @param string $branchBankCode 支行编码<br>银行卡所在支行编码，详见支行编码列表
     *
     * @return $this
     */
     ...
     * Sets feeChargeSide
     *
     * @param string $feeChargeSide 手续费承担方(若不传默认付款方)<br>可选项如下:<br>PAYER:付款方<br>PAYEE:收款方
     *
     * @return $this
     */
