...
class TransferB2bOrderAuditQueryRequestMarshaller implements RequestMarshaller
{
    /**
     * @var TransferB2bOrderAuditQueryRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new TransferB2bOrderAuditQueryRequestMarshaller();
    }

    /**
     * @return TransferB2bOrderAuditQueryRequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v1.0/account/transfer/b2b/order/audit-query';
    ...
    /**
     * @param TransferB2bOrderAuditQueryRequest $request
     * @return Request
     */
...
TransferB2bOrderAuditQueryRequestMarshaller::__init();
