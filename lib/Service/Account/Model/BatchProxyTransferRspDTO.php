...
/**
 * BatchProxyTransferRspDTO Class Doc Comment
 *
 * @category Class
 * @description 转账到支付宝响应结果
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BatchProxyTransferRspDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BatchProxyTransferRspDTO';
     ...
     * Sets returnCode
     *
     * @param string $returnCode <p>返回码</p> <p>成功：UA00000</p>
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status <p>状态</p> 可选项如下: INIT:初始化 PROCESS:进行中 FAIL:失败 COMPLETE:处理完成
     *
     * @return $this
     */
