...
/**
 * ApplyAddAuditorRespDTO Class Doc Comment
 *
 * @category Class
 * @description 请修改我
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApplyAddAuditorRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApplyAddAuditorRespDTO';
     ...
     * Sets applyStatus
     *
     * @param string $applyStatus <p>WAIT_VERIFY: 待验证</p> <p>SUCCESS: 成功</p> <p>FAIL: 失败</p>
     *
     * @return $this
     */
