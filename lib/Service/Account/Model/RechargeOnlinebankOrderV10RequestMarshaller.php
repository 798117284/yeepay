...
class RechargeOnlinebankOrderV10RequestMarshaller implements RequestMarshaller
{
    /**
     * @var RechargeOnlinebankOrderV10RequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new RechargeOnlinebankOrderV10RequestMarshaller();
    }

    /**
     * @return RechargeOnlinebankOrderV10RequestMarshaller
     */
    ...
    /**
     * @param RechargeOnlinebankOrderV10Request $request
     * @return Request
     */
    public function marshal($request)
    {
        ...
        if($request->getPayType() != null){
            $internalRequest->addParameter('payType', ObjectSerializer::sanitizeForSerialization($request->getPayType(), 'string', 'enum'));
        }
...
RechargeOnlinebankOrderV10RequestMarshaller::__init();
