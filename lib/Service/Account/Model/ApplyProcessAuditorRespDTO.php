...
/**
 * ApplyProcessAuditorRespDTO Class Doc Comment
 *
 * @category Class
 * @description 请修改我
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApplyProcessAuditorRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApplyProcessAuditorRespDTO';
     ...
     * Sets status
     *
     * @param string $status <p>EFFECTIVE: 生效</p> <p>INVALID: 失效</p>
     *
     * @return $this
     */
