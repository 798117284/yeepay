...
/**
 * RechargeApiV2ResponseDTO Class Doc Comment
 *
 * @category Class
 * @description 充值下单响应参数
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RechargeApiV2ResponseDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RechargeApiV2ResponseDTO';
     ...
     * Sets returnCode
     *
     * @param string $returnCode <p>返回码<br />UA00000 成功,其他请参考错误码</p>
     *
     * @return $this
     */
     ...
     * Sets returnMsg
     *
     * @param string $returnMsg <p>对于返回码的描述信息</p>
     *
     * @return $this
     */
     ...
     * Sets orderNo
     *
     * @param string $orderNo <p>此订单在易宝的订单号</p>
     *
     * @return $this
     */
     ...
     * Sets requestNo
     *
     * @param string $requestNo <p>商户订单号 同入参</p>
     *
     * @return $this
     */
     ...
     * Sets merchantNo
     *
     * @param string $merchantNo <p>业务主体商编</p>
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status <p>可选项如下:<br />INIT:已受理<br />PAY_SUCCESS:支付成功<br />FAIL:失败<br />SUCCESS: 充值成功</p>
     *
     * @return $this
     */
     ...
     * Sets orderAmount
     *
     * @param float $orderAmount <p>充值金额</p>
     *
     * @return $this
     */
     ...
     * Sets remitComment
     *
     * @param string $remitComment <p>打款附言- 仅银行转账方式会返回</p>
     *
     * @return $this
     */
     ...
     * Sets payUrl
     *
     * @param string $payUrl <p>收银台链接地址,仅限B2B,B2C方式会返回</p>
     *
     * @return $this
     */
