...
/**
 * QueryWechatTransferRespDTO Class Doc Comment
 *
 * @category Class
 * @description 响应结果
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class QueryWechatTransferRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'QueryWechatTransferRespDTO';
     ...
     * Sets status
     *
     * @param string $status 可选项如下:<br>SUCCESS:成功<br>FAIL:失败<br>CLOSE:关闭<br>PROCESSING:处理中
     *
     * @return $this
     */
     ...
     * Sets orderNo
     *
     * @param string $orderNo 易宝转账订单号<br>易宝支付系统生成的转账订单号
     *
     * @return $this
     */
     ...
     * Sets openId
     *
     * @param string $openId openId是微信用户在公众号appId下的唯一用户标识
     *
     * @return $this
     */
     ...
     * Sets finishTime
     *
     * @param string $finishTime 只有成功，失败和关闭的时候才有完成时间
     *
     * @return $this
     */
     ...
     * Sets bankOrderNo
     *
     * @param string $bankOrderNo 备注：只有status为SUCCESS有值
     *
     * @return $this
     */
