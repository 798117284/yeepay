...
class GroupAccountTransferQueryRespDTO implements ModelInterface, ArrayAccess
{
     ...
     * Sets orderNo
     *
     * @param string $orderNo <p>易宝支付系统生成的订单号</p>
     *
     * @return $this
     */
     ...
     * Sets transferStatus
     *
     * @param string $transferStatus <p>可选项如下:<br />REQUEST_RECEIVE:请求已接收(易宝正在处理中,收到最终结果前请勿重复下单)<br />SUCCESS:成功<br />FAIL:失败(该笔订单失败,可重新发起)</p>
     *
     * @return $this
     */
     ...
     * Sets createTime
     *
     * @param string $createTime <p>返回易宝接收请求后创建订单时间</p>
     *
     * @return $this
     */
     ...
     * Sets finishTime
     *
     * @param string $finishTime <p>返回订单有明确结果（如订单状态为SUCCESS/FAIL）时的时间</p>
     *
     * @return $this
     */
     ...
     * Sets failReason
     *
     * @param string $failReason <p>状态为FAIL返回</p>
     *
     * @return $this
     */
