...
/**
 * RechargeQueryMultiApiRespDTO Class Doc Comment
 *
 * @category Class
 * @description 充值查询明细的返回参数
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RechargeQueryMultiApiRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RechargeQueryMultiApiRespDTO';
    ...
    protected static $swaggerTypes = [
        'returnCode' => 'string',
        'returnMsg' => 'string',
        'list' => '\Yeepay\Yop\Sdk\Service\Account\Model\RechargeOrderApiDto[]'
    ];
     ...
     * Gets list
     *
     * @return \Yeepay\Yop\Sdk\Service\Account\Model\RechargeOrderApiDto[]
     */
     ...
     * Sets list
     *
     * @param \Yeepay\Yop\Sdk\Service\Account\Model\RechargeOrderApiDto[] $list <p>订单列表</p>
     *
     * @return $this
     */
