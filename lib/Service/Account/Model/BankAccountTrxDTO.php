...
class BankAccountTrxDTO implements ModelInterface, ArrayAccess
{
     ...
     * Sets loanFlag
     *
     * @param string $loanFlag 可选项如下: DEBIT:出金 CREDIT:入金
     *
     * @return $this
     */
     ...
     * Sets tradeStatus
     *
     * @param string $tradeStatus 可选项如下: SUCCESS:成功 FAIL:失败 REVERSE:冲正 BE_REVERSE:被冲正 UNKNOW:未知
     *
     * @return $this
     */
     ...
     * Sets trxDateTime
     *
     * @param string $trxDateTime <p>格式：yyyy-MM-dd HH:mm:ss</p>
     *
     * @return $this
     */
