...
class XwbzOpenAccountDTO implements ModelInterface, ArrayAccess
{
     ...
     * Sets notifySmsUrl
     *
     * @param string $notifySmsUrl <p>短验通知路径开户申请银行审核后通知到该地址，商户接收后发起申请短验, 通知内容请参照页签<a href=\"#anchor7\">开立银行账户-申请短验通知</a></p>
     *
     * @return $this
     */
     ...
     * Sets bindCardType
     *
     * @param string $bindCardType <p>可选项如下:<br />PUBLIC_CARD:对公卡<br />PRIVATE_CARD:对私卡</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $businessValidStart <p>参数格式为yyyyMMdd</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $businessValidEnd <p>参数格式为yyyyMMdd或者forever</p>
     *
     * @return $this
     */
     ...
     * Sets contactName
     *
     * @param string $contactName <p>用于开户过程中做短验申请和确认使用</p>
     *
     * @return $this
     */
     ...
     * Sets contactMobile
     *
     * @param string $contactMobile <p>法人和联系人非同一人时，手机号不能是同一个</p>
     *
     * @return $this
     */
     ...
     *
     * @param \Yeepay\Yop\Sdk\Service\Account\Model\BenefitInfoReqDTO[] $benefitInfoReqDTOList <p>不能超过4个</p>
     *
     * @return $this
     */
     ...
     *
     * @param \Yeepay\Yop\Sdk\Service\Account\Model\ShareHolderInfoReqDTO[] $shareHolderInfoList <p>不能超过4个</p>
     *
     * @return $this
     */
