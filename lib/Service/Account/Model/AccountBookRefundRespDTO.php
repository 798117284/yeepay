...
/**
 * AccountBookRefundRespDTO Class Doc Comment
 *
 * @category Class
 * @description 响应结果
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AccountBookRefundRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccountBookRefundRespDTO';
     ...
     * Sets returnCode
     *
     * @param string $returnCode <p>返回码UA00000&nbsp;成功<br />示例值：UA00000</p>
     *
     * @return $this
     */
     ...
     * Sets refundStatus
     *
     * @param string $refundStatus <p>可选项如下:<br />REFUNDPROCESS:退款处理中<br />FAIL:退款失败</p>
     *
     * @return $this
     */
     ...
     * Sets refundAmount
     *
     * @param float $refundAmount 退款金额。单位为元，精确到小数点后两位
     *
     * @return $this
     */
     ...
     *
     * @param string $merchantRefundRequestNo <p>商户退款请求号。可包含字母、数字、下划线；需保证在商户端不重复</p>
     *
     * @return $this
     */
