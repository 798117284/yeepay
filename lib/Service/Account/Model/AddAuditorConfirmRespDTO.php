...
/**
 * AddAuditorConfirmRespDTO Class Doc Comment
 *
 * @category Class
 * @description 请修改我
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddAuditorConfirmRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AddAuditorConfirmRespDTO';
     ...
     * Sets applyStatus
     *
     * @param string $applyStatus <p>WAIT_VERIFY: 待审核人验证(一般是验证码错误时返回，可以继续验证码确认)<br />SUCCESS: 成功<br />FAIL: 失败(原因不确定，比如验证码校验通过，但是发现有重复手机号时会出现，不可继续验证码确认)</p>
     *
     * @return $this
     */
