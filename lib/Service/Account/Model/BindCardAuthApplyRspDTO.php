...
/**
 * BindCardAuthApplyRspDTO Class Doc Comment
 *
 * @category Class
 * @description 请修改我
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BindCardAuthApplyRspDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BindCardAuthApplyRspDTO';
     ...
     * Sets dealStatus
     *
     * @param string $dealStatus <p>处理状态<br />SUCCESS 业务执行成功<br />FAIL 业务执行失败</p>
     *
     * @return $this
     */
