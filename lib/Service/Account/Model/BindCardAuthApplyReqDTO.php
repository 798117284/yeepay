...
/**
 * BindCardAuthApplyReqDTO Class Doc Comment
 *
 * @category Class
 * @description 请修改我
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BindCardAuthApplyReqDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BindCardAuthApplyReqDTO';
     ...
     *
     * @param string $businessOrderNo <p>易宝订单号易宝唯一流水号（调用&ldquo;开立银行清分账户&rdquo;后返回给商户的businessOrderNo）</p>
     *
     * @return $this
     */
