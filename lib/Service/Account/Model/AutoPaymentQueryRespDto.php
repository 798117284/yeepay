...
/**
 * AutoPaymentQueryRespDto Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AutoPaymentQueryRespDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AutoPaymentQueryRespDto';
     ...
     * Sets code
     *
     * @param string $code 响应编码UA00000成功
     *
     * @return $this
     */
     ...
     * Sets orderStatus
     *
     * @param string $orderStatus 可选项如下:<br>SUCCESS:成功<br>FAIL:失败
     *
     * @return $this
     */
