...
/**
 * RemitCancelRespDTO Class Doc Comment
 *
 * @category Class
 * @description 代付撤销响应参数
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RemitCancelRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RemitCancelRespDTO';
     ...
     * Sets status
     *
     * @param string $status <p>撤销结果<br />可选项如下:<br />SUCCESS:成功（该笔付款已经撤销）<br />FAIL:失败（该笔订单会继续进行付款，请商户关注付款资金到账情况）</p>
     *
     * @return $this
     */
