...
/**
 * ApplySupplierRespDTO Class Doc Comment
 *
 * @category Class
 * @description 申请添加供应商响应结果
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApplySupplierRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApplySupplierRespDTO';
     ...
     *
     * @param string $applicationStatus 可选项如下: RECEIVE:已接收 REVIEWING:协议待签署 SUCCESS:成功 REJECT:失败
     *
     * @return $this
     */
