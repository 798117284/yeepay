...
class BankAccountRefundReqDTO implements ModelInterface, ArrayAccess
{
     ...
     * Sets refundFlowNo
     *
     * @param string $refundFlowNo <p>商户退回请求号<br />由商户自定义生成</p>
     *
     * @return $this
     */
     ...
     * Sets bankSerialNo
     *
     * @param string $bankSerialNo <p>银行流水号,入金通知里对应的银行流水号</p>
     *
     * @return $this
     */
     ...
     * Sets bankCode
     *
     * @param string $bankCode <p>开户银行编码</p> <p>可选项如下：</p> <p>SMB_LARGE</p>
     *
     * @return $this
     */
     ...
     * Sets refundAmount
     *
     * @param float $refundAmount <p>退回金额<br />单位：元（RMB）</p>
     *
     * @return $this
     */
     ...
     * Sets notifyUrl
     *
     * @param string $notifyUrl <p>商户通知地址，不传则不通知回调内容请查看结果通知</p>
     *
     * @return $this
     */
