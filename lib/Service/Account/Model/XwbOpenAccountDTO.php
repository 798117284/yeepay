...
class XwbOpenAccountDTO implements ModelInterface, ArrayAccess
{
     ...
     * Sets notifySmsUrl
     *
     * @param string $notifySmsUrl <p>开户申请银行审核后通知到该地址，商户接收后发起申请短验，通知内容请参照页签<a href=\"#anchor7\">开立银行账户-申请短验通知</a></p>
     *
     * @return $this
     */
     ...
     * Sets bindCardType
     *
     * @param string $bindCardType 可选项如下:<br>PUBLIC_CARD:对公卡<br>PRIVATE_CARD:对私卡
     *
     * @return $this
     */
     ...
     * Sets contactMobile
     *
     * @param string $contactMobile 法人和联系人非同一人时，手机号不能是同一个
     *
     * @return $this
     */
     ...
     *
     * @param string $contactCardType 可选项如下:<br>ID_CARD:身份证
     *
     * @return $this
     */
     ...
     *
     * @param \Yeepay\Yop\Sdk\Service\Account\Model\ShareHolderInfoReqDTO[] $shareHolderInfoList 不能超过4个
     *
     * @return $this
     */
