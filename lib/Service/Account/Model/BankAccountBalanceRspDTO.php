...
/**
 * BankAccountBalanceRspDTO Class Doc Comment
 *
 * @category Class
 * @description 请修改我
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BankAccountBalanceRspDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BankAccountBalanceRspDTO';
     ...
     * Sets accountType
     *
     * @param string $accountType <p>账户类型</p> <pre>V_BANK_ECITIC_CLEARING_ACCOUNT:中信清分账户</pre> <pre>V_BANK_SN_CLEARING_ACCOUNT:苏商清分账户</pre>
     *
     * @return $this
     */
