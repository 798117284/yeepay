...
/**
 * TransferAuditVerifySmsRespDTO Class Doc Comment
 *
 * @category Class
 * @description 请修改我
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TransferAuditVerifySmsRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TransferAuditVerifySmsRespDTO';
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getAuditStatusAllowableValues();
        if (!is_null($this->container['auditStatus']) && !in_array($this->container['auditStatus'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'auditStatus', must be one of '%s'",
     ...
     * Sets auditStatus
     *
     * @param string $auditStatus 可选项如下: SUCCESS:复核成功
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getAuditStatusAllowableValues();
        if (!is_null($auditStatus) && !in_array($auditStatus, $allowedValues, true)) {
