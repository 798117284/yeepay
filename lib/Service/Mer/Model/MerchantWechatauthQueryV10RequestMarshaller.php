...
class MerchantWechatauthQueryV10RequestMarshaller implements RequestMarshaller
{
    /**
     * @var MerchantWechatauthQueryV10RequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new MerchantWechatauthQueryV10RequestMarshaller();
    }

    /**
     * @return MerchantWechatauthQueryV10RequestMarshaller
     */
    ...
    /**
     * @param MerchantWechatauthQueryV10Request $request
     * @return Request
     */
    public function marshal($request)
    {
        ...
        if($request->getCustomQrcode() != null){
            $internalRequest->addParameter('customQrcode', ObjectSerializer::sanitizeForSerialization($request->getCustomQrcode(), 'bool'));
        }
...
MerchantWechatauthQueryV10RequestMarshaller::__init();
