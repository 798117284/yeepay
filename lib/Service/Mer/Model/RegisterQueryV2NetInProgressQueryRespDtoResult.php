...
class RegisterQueryV2NetInProgressQueryRespDtoResult implements ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        ...
        'openAccountResult' => 'setOpenAccountResult'
    ];
    ...
    protected static $getters = [
        ...
        'openAccountResult' => 'getOpenAccountResult'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['openAccountResult'] = isset($data['openAccountResult']) ? $data['openAccountResult'] : null;
    }
     ...
     *
     * @param string $intentionAuthUrl 意愿认证地址
     *
     * @return $this
     */
    ...
    /**
     * Gets openAccountResult
     *
     * @return string
     */
    public function getOpenAccountResult()
    {
        return $this->container['openAccountResult'];
    }

    /**
     * Sets openAccountResult
     *
     * @param string $openAccountResult 开户结果
     *
     * @return $this
     */
    public function setOpenAccountResult($openAccountResult)
    {
        $this->container['openAccountResult'] = $openAccountResult;
