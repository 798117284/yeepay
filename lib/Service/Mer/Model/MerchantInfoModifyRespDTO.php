...
/**
 * MerchantInfoModifyRespDTO Class Doc Comment
 *
 * @category Class
 * @description 响应结果
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MerchantInfoModifyRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MerchantInfoModifyRespDTO';
     ...
     * Sets applicationNo
     *
     * @param string $applicationNo 请求参数必填、格式、参数合法性等校验通过后返回
     *
     * @return $this
     */
     ...
     *
     * @param string $applicationStatus 请求参数必填、格式、参数合法性等校验通过后返回<br>申请状态可选项如下:<br>REVIEWING:申请审核中<br>REVIEW_BACK:申请已驳回
     *
     * @return $this
     */
     ...
     * Sets merchantNo
     *
     * @param string $merchantNo 商户编号<br>接口响应成功时返回
     *
     * @return $this
     */
