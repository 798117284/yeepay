...
class RestV2MerBossRegisterSaasStandardRequestMarshaller implements RequestMarshaller
{
    /**
     * @var RestV2MerBossRegisterSaasStandardRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new RestV2MerBossRegisterSaasStandardRequestMarshaller();
    }

    /**
     * @return RestV2MerBossRegisterSaasStandardRequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v2.0/mer/boss/register/saas/standard';
    ...
    /**
     * @param RestV2MerBossRegisterSaasStandardRequest $request
     * @return Request
     */
    public function marshal($request)
    {
        ...
        if($request->getSellerNo() != null){
            $internalRequest->addParameter('sellerNo', ObjectSerializer::sanitizeForSerialization($request->getSellerNo(), 'string'));
        }
...
RestV2MerBossRegisterSaasStandardRequestMarshaller::__init();
