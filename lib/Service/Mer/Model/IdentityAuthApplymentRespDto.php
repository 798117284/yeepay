...
/**
 * IdentityAuthApplymentRespDto Class Doc Comment
 *
 * @category Class
 * @description 实名认证申请结果
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IdentityAuthApplymentRespDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IdentityAuthApplymentRespDto';
     ...
     * Sets returnCode
     *
     * @param string $returnCode <div data-page-id=\"DrEgd5UiTolweFx1SI4cl1jUnRg\" data-lark-html-role=\"root\" data-docx-has-block-data=\"false\"> <div class=\"ace-line ace-line old-record-id-XJjtdjonhoKbiWxcrxxcTXiVnEh\">BMS00000 为成功</div> <div class=\"ace-line ace-line old-record-id-ZO0adgohbo4hUFxZL9jc88oEn1j\">其他均为失败</div> </div>
     *
     * @return $this
     */
     ...
     * Sets applymentId
     *
     * @param string $applymentId <div class=\"params-content\" data-v-34cd6e8b=\"\">申请单编号</div>
     *
     * @return $this
     */
