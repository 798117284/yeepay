...
/**
 * BankCardBindRespDTO Class Doc Comment
 *
 * @category Class
 * @description 用户银行卡绑定响应参数
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BankCardBindRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BankCardBindRespDTO';
