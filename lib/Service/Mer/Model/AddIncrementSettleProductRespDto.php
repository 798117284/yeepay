<?php
/**
 * AddIncrementSettleProductRespDto
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * AddIncrementSettleProductRespDto Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddIncrementSettleProductRespDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AddIncrementSettleProductRespDto';
     ...
     *
     * @param string $applicationStatus 申请状态<br>REVIEWING:申请审核中<br>REVIEW_BACK:申请已驳回<br>BUSINESS_OPENING:业务开通中<br>COMPLETED:申请已完成
     *
     * @return $this
     */
