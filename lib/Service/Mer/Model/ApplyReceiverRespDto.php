...
/**
 * ApplyReceiverRespDto Class Doc Comment
 *
 * @category Class
 * @description 申请入账方响应参数
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApplyReceiverRespDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApplyReceiverRespDto';
     ...
     * Sets receiverNo
     *
     * @param string $receiverNo <div data-zone-id=\"0\" data-line-index=\"0\" data-line=\"true\">申请入账方后由系统创建的入账方编号。入账方申请状态为申请已完成时返回入账方编号。</div> <div data-zone-id=\"0\" data-line-index=\"1\" data-line=\"true\">入账方编号将会用于后续的信息变更、分账发起等环节，建议服务商存储该字段信息。</div>
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status <p>入账方申请后，完成确认书签署和易宝系统业务开通，到达申请已完成状态即完成入账方申请。 申请已完成为业务终态，代表入账方已经添加完成。 审核已驳回时，需要更换请求号重新发起申请。其中审核驳回、确认书待签署、申请已完成会给商户发送回调通知。</p> 可选项如下: PROCESSING:申请中 REVIEW_BACK:审核驳回 AGREEMENT_SIGNING:确认书待签署 BUSINESS_OPENING:业务开通中 COMPLETED:申请已完成
     *
     * @return $this
     */
