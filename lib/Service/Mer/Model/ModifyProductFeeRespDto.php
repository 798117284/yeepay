...
/**
 * ModifyProductFeeRespDto Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ModifyProductFeeRespDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModifyProductFeeRespDto';
     ...
     *
     * @param string $applicationStatus 申请状态可选项如下:<br>REVIEWING:申请审核中<br>REVIEW_BACK:申请已驳回<br>AGREEMENT_SIGNING:协议待签署<br>BUSINESS_OPENING:业务开通中<br>COMPLETED:申请已完成
     *
     * @return $this
     */
