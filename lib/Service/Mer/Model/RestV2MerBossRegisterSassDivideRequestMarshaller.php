...
class RestV2MerBossRegisterSassDivideRequestMarshaller implements RequestMarshaller
{
    /**
     * @var RestV2MerBossRegisterSassDivideRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new RestV2MerBossRegisterSassDivideRequestMarshaller();
    }

    /**
     * @return RestV2MerBossRegisterSassDivideRequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v2.0/mer/boss/register/saas/divide';
    ...
    /**
     * @param RestV2MerBossRegisterSassDivideRequest $request
     * @return Request
     */
...
RestV2MerBossRegisterSassDivideRequestMarshaller::__init();
