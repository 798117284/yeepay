...
class ProductFeeModifyV20RequestMarshaller implements RequestMarshaller
{
    /**
     * @var ProductFeeModifyV20RequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new ProductFeeModifyV20RequestMarshaller();
    }

    /**
     * @return ProductFeeModifyV20RequestMarshaller
     */
    ...
    /**
     * @param ProductFeeModifyV20Request $request
     * @return Request
     */
    public function marshal($request)
    {
        ...
        if($request->getBusinessNotifyUrl() != null){
            $internalRequest->addParameter('businessNotifyUrl', ObjectSerializer::sanitizeForSerialization($request->getBusinessNotifyUrl(), 'string'));
        }
        ...
        if($request->getProductConfigInfo() != null){
            $internalRequest->addParameter('productConfigInfo', ObjectSerializer::sanitizeForSerialization($request->getProductConfigInfo(), 'string'));
        }
        if($request->getBusinessConfig() != null){
            $internalRequest->addParameter('businessConfig', ObjectSerializer::sanitizeForSerialization($request->getBusinessConfig(), 'string'));
        }
        if($request->getMerchantAgreementInfo() != null){
            $internalRequest->addParameter('merchantAgreementInfo', ObjectSerializer::sanitizeForSerialization($request->getMerchantAgreementInfo(), 'string'));
        }
        if($request->getBankOpenAccountInfo() != null){
            $internalRequest->addParameter('bankOpenAccountInfo', ObjectSerializer::sanitizeForSerialization($request->getBankOpenAccountInfo(), 'string'));
        }
        if($request->getParentMerchantNo() != null){
            $internalRequest->addParameter('parentMerchantNo', ObjectSerializer::sanitizeForSerialization($request->getParentMerchantNo(), 'string'));
        }
        if($request->getMerchantExtraInfo() != null){
            $internalRequest->addParameter('merchantExtraInfo', ObjectSerializer::sanitizeForSerialization($request->getMerchantExtraInfo(), 'string'));
        }
...
ProductFeeModifyV20RequestMarshaller::__init();
