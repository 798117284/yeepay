...
class SubsidyQueryYopQuerySubsidyResDTOResult implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['subsidyFee'] = isset($data['subsidyFee']) ? $data['subsidyFee'] : null;
    ...
    {
        return $this->container['subsidyFee'];
    }

    /**
     * Sets subsidyFee
     *
     * @param string $subsidyFee 补贴手续费
     *
     * @return $this
     */
    public function setSubsidyFee($subsidyFee)
    {
        $this->container['subsidyFee'] = $subsidyFee;
     ...
     * Sets debitAmount
     *
     * @param string $debitAmount 补贴出资方扣账金额
     *
     * @return $this
     */
     ...
     * Sets receiveAmount
     *
     * @param string $receiveAmount 补贴接收方到账金额
     *
     * @return $this
     */
