...
class OrderRequest extends \Yeepay\Yop\Sdk\Model\BaseRequest
{
    ...
    /**
     * Gets merGoodsInfoList
     *
     * @return string
     */
    public function getMerGoodsInfoList()
    {
        return $this->merGoodsInfoList;
    }

    /**
     * Sets merGoodsInfoList
     *
     * @param string $merGoodsInfoList
     * @return OrderRequest
     */
    public function setMerGoodsInfoList($merGoodsInfoList)
    {
        $this->merGoodsInfoList = $merGoodsInfoList;
        return $this;
    }
