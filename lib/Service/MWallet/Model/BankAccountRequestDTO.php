...
class BankAccountRequestDTO implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $parentMerchantNo 发起方商户编号<br>（标准商户收付款方案中此参数与商编一致，平台商户收付款方案中此参数为平台商商户编号）
     *
     * @return $this
     */
     ...
     * Sets requestNo
     *
     * @param string $requestNo 每次开户的请求号不能重复
     *
     * @return $this
     */
     ...
     *
     * @param string $merchantMemberNo 商户侧存的会员编号，不同人的会员编号不能相同
     *
     * @return $this
     */
     ...
     * Sets accountType
     *
     * @param string $accountType 可选项如下:<br>CNCB:中信银行
     *
     * @return $this
     */
     ...
     *
     * @param string $bankAccountLevel 可选项如下:<br>ONEACCOUNT:一类户<br>TWOACCOUNT:二类户<br>THREEACCOUNT:三类户
     *
     * @return $this
     */
