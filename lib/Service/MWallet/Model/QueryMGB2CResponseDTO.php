...
class QueryMGB2CResponseDTO implements ModelInterface, ArrayAccess
{
     ...
     * Sets orderAmount
     *
     * @param float $orderAmount <p>转账订单金额</p>
     *
     * @return $this
     */
     ...
     * Sets orderStatus
     *
     * @param string $orderStatus <p>转账订单的4个状态<br />可选项如下:<br />UNCREDITED:已受理-处理中<br />NOT_VERIFIED:待确认<br />CREDITED:转账成功<br />COMMIT_FAILURE:转账失败</p>
     *
     * @return $this
     */
     ...
     * Sets toMerchantNo
     *
     * @param string $toMerchantNo <p>转帐接收方用户所在平台商编</p>
     *
     * @return $this
     */
     ...
     * Sets toMemberNo
     *
     * @param string $toMemberNo <p>转入方易宝用户编号</p>
     *
     * @return $this
     */
