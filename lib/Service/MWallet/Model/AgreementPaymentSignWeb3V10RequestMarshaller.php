...
class AgreementPaymentSignWeb3V10RequestMarshaller implements RequestMarshaller
{
    ...
    public function marshal($request)
    {
        ...
        if($request->getAgreementAmount() != null){
            $internalRequest->addParameter('agreementAmount', ObjectSerializer::sanitizeForSerialization($request->getAgreementAmount(), 'string'));
        }
