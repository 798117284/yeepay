...
class WalletQueryWithdrawResultDTO implements ModelInterface, ArrayAccess
{
     ...
     * Sets businessNo
     *
     * @param string $businessNo <p>易宝订单号</p>
     *
     * @return $this
     */
     ...
     * Sets cardNo
     *
     * @param string $cardNo <p>显示前4后2，中间*</p>
     *
     * @return $this
     */
     ...
     * Sets tradeStatus
     *
     * @param string $tradeStatus <p>可选项如下:<br />SUCCESS:成功<br />FAIL:失败<br />ACCEPTED:打款中</p>
     *
     * @return $this
     */
     ...
     * Sets acceptTime
     *
     * @param \DateTime $acceptTime <p>受理时间</p>
     *
     * @return $this
     */
     ...
     * Sets completeTime
     *
     * @param \DateTime $completeTime <p>完成时间</p>
     *
     * @return $this
     */
     ...
     * Sets withdrawType
     *
     * @param string $withdrawType <p>可选项如下:<br />0:提现实时到账<br />1:提现2小时到账<br />2:次日到账</p>
     *
     * @return $this
     */
     ...
     *
     * @param float $deductionAmount <p>实际扣款金额</p>
     *
     * @return $this
     */
     ...
     * Sets arrivalAmount
     *
     * @param float $arrivalAmount <p>到账金额</p>
     *
     * @return $this
     */
     ...
     * Sets feeInnerType
     *
     * @param string $feeInnerType <p>可选项如下:<br />INNER:内扣<br />OUTER:外扣<br />OUTER_TO_INNER:外扣转内扣</p>
     *
     * @return $this
     */
