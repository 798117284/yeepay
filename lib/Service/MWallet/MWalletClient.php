...
class MWalletClient
{
    ...
    /**
     * @param Model\AccountQueryBalanceV10Request $request
     * @return Model\AccountQueryBalanceV10Response
     * @throws YopClientException
     */
    public function account_query_balance_v1_0(Model\AccountQueryBalanceV10Request $request)
    {
        if ($request == null) {
            throw new YopClientException("request is required.");
        }
        $clientExecutionParams = new ClientExecutionParams($request, Model\AccountQueryBalanceV10RequestMarshaller::getInstance(),
            Model\AccountQueryBalanceV10ResponseUnMarshaller::getInstance());
        return $this->clientHandler->execute($clientExecutionParams);
    }
    /**
     * @param Model\AccountQueryQuotaRequest $request
