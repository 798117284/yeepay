...
/**
 * AuthReportQueryResponseDTO Class Doc Comment
 *
 * @category Class
 * @description 响应结果
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AuthReportQueryResponseDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AuthReportQueryResponseDTO';
    ...
    protected static $swaggerTypes = [
        ...
        'extInfo' => 'string',
        'cardUseType' => 'string',
        'openCardTime' => '\DateTime',
        'cardUseOutTime' => '\DateTime',
        'cardOrganization' => 'string',
        'details' => '\Yeepay\Yop\Sdk\Service\AtVcc\Model\AuthReportDetailResponseDTO[]'
    ];
     ...
     * Sets cardUseType
     *
     * @param string $cardUseType 可选项如下:<br>SINGLE:单次卡<br>MULTIPLE:多次卡
     *
     * @return $this
     */
     ...
     * Sets openCardTime
     *
     * @param \DateTime $openCardTime 开卡时间
     *
     * @return $this
     */
     ...
     * Sets cardUseOutTime
     *
     * @param \DateTime $cardUseOutTime 关闭时间
     *
     * @return $this
     */
     ...
     * Gets details
     *
     * @return \Yeepay\Yop\Sdk\Service\AtVcc\Model\AuthReportDetailResponseDTO[]
     */
     ...
     * Sets details
     *
     * @param \Yeepay\Yop\Sdk\Service\AtVcc\Model\AuthReportDetailResponseDTO[] $details details
     *
     * @return $this
     */
