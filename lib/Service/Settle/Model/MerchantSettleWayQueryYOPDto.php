...
class MerchantSettleWayQueryYOPDto implements ModelInterface, ArrayAccess
{
     ...
     * Sets settleWay
     *
     * @param string $settleWay <p>可选项如下:<br />BANKCARD:结算至银行卡<br />ACCOUNT:结算至资金账户<br />BANKACCOUNT:结算至合作银行</p>
     *
     * @return $this
     */
     ...
     * Sets settleRatio
     *
     * @param double $settleRatio <p>该结算方向对应的结算比例。单位：%，两位小数。如返回80.00，则表示结算资金的80.00%（四舍五入后保留两位小数）将结算至相应结算方向。</p>
     *
     * @return $this
     */
     ...
     * Sets bankCardNo
     *
     * @param string $bankCardNo <p>结算方向为结算到银行卡/合作银行时返回</p>
     *
     * @return $this
     */
     ...
     * Sets accountName
     *
     * @param string $accountName <p>结算方向为结算到银行卡/合作银行时返回</p>
     *
     * @return $this
     */
