...
class SelfSettleApplyRequestMarshaller implements RequestMarshaller
{
    ...
    public function marshal($request)
    {
        ...
        if($request->getSettleAmount() != null){
            $internalRequest->addParameter('settleAmount', ObjectSerializer::sanitizeForSerialization($request->getSettleAmount(), 'float'));
        }
        ...
        if($request->getExtInfo() != null){
            $internalRequest->addParameter('extInfo', ObjectSerializer::sanitizeForSerialization($request->getExtInfo(), 'string'));
        }
