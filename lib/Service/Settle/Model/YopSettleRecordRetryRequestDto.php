<?php
/**
 * YopSettleRecordRetryRequestDto
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * YopSettleRecordRetryRequestDto Class Doc Comment
 *
 * @category Class
 * @description 重新出款请求参数
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class YopSettleRecordRetryRequestDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'YopSettleRecordRetryRequestDto';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['yeepayFlowNo'] === null) {
            $invalidProperties[] = "'yeepayFlowNo' can't be null";
        }
     ...
     *
     * @param string $receiverMerchantNo receiverMerchantNo
     *
     * @return $this
     */
     ...
     * Sets yeepayFlowNo
     *
     * @param string $yeepayFlowNo yeepayFlowNo
     *
     * @return $this
     */
