...
class ModifySettleWayRatioRequestDto implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['settleWayRatioDetailDtoList'] === null) {
            $invalidProperties[] = "'settleWayRatioDetailDtoList' can't be null";
        }
     ...
     *
     * @param \Yeepay\Yop\Sdk\Service\Settle\Model\SettleWayRatioDetailDto[] $settleWayRatioDetailDtoList <p>请注意此字段是数组类型</p>
     *
     * @return $this
     */
