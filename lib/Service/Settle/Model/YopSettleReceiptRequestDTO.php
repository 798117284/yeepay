...
class YopSettleReceiptRequestDTO implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $receiverMerchantNo <div><span class=\"text-only\" data-eleid=\"5\">用于申请入账方的结算回单，</span></div>
     *
     * @return $this
     */
     ...
     *
     * @param string $settleStartTime settleStartTime
     *
     * @return $this
     */
     ...
     * Sets settleEndTime
     *
     * @param string $settleEndTime settleEndTime
     *
     * @return $this
     */
     ...
     *
     * @param string $settleRequestNo settleRequestNo
     *
     * @return $this
     */
