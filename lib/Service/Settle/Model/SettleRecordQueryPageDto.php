...
/**
 * SettleRecordQueryPageDto Class Doc Comment
 *
 * @category Class
 * @description 分页查询结算记录返回实体
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SettleRecordQueryPageDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SettleRecordQueryPageDto';
     ...
     * Sets status
     *
     * @param string $status <p>SUCCESS:结算成功 PROCESS:处理中 SETTLE_FAIL:结算异常</p>
     *
     * @return $this
     */
