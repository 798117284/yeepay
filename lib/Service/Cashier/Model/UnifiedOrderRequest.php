...
class UnifiedOrderRequest extends \Yeepay\Yop\Sdk\Model\BaseRequest
{
     ...
     * @return string
     */
    public function getOtherTypeParam()
    {
        return $this->otherTypeParam;
    }

    /**
     * Sets otherTypeParam
     *
     * @param string $otherTypeParam
     * @return UnifiedOrderRequest
     */
    public function setOtherTypeParam($otherTypeParam)
    {
        $this->otherTypeParam = $otherTypeParam;
        return $this;
    }
