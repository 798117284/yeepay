...
class TutelagePrePayV10RequestMarshaller implements RequestMarshaller
{
    /**
     * @var TutelagePrePayV10RequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new TutelagePrePayV10RequestMarshaller();
    }

    /**
     * @return TutelagePrePayV10RequestMarshaller
     */
    ...
    /**
     * @param TutelagePrePayV10Request $request
     * @return Request
     */
    public function marshal($request)
    {
        ...
        if($request->getMerchantMiniInfo() != null){
            $internalRequest->addParameter('merchantMiniInfo', ObjectSerializer::sanitizeForSerialization($request->getMerchantMiniInfo(), 'string'));
        }
...
TutelagePrePayV10RequestMarshaller::__init();
