...
class PrePayV10RequestMarshaller implements RequestMarshaller
{
    /**
     * @var PrePayV10RequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new PrePayV10RequestMarshaller();
    }

    /**
     * @return PrePayV10RequestMarshaller
     */
    ...
    /**
     * @param PrePayV10Request $request
     * @return Request
     */
    public function marshal($request)
    {
        ...
        if($request->getFundProcessType() != null){
            $internalRequest->addParameter('fundProcessType', ObjectSerializer::sanitizeForSerialization($request->getFundProcessType(), 'string', 'enum'));
        }
        ...
        if($request->getChannel() != null){
            $internalRequest->addParameter('channel', ObjectSerializer::sanitizeForSerialization($request->getChannel(), 'string', 'enum'));
        }
        ...
        if($request->getDivideNotifyUrl() != null){
            $internalRequest->addParameter('divideNotifyUrl', ObjectSerializer::sanitizeForSerialization($request->getDivideNotifyUrl(), 'string', 'notify-url'));
        }
        ...
        if($request->getReceiverAccountType() != null){
            $internalRequest->addParameter('receiverAccountType', ObjectSerializer::sanitizeForSerialization($request->getReceiverAccountType(), 'string'));
        }
        if($request->getJdbtPaymentInfo() != null){
            $internalRequest->addParameter('jdbtPaymentInfo', ObjectSerializer::sanitizeForSerialization($request->getJdbtPaymentInfo(), 'string'));
        }
        if($request->getAppUpIdentifier() != null){
            $internalRequest->addParameter('appUpIdentifier', ObjectSerializer::sanitizeForSerialization($request->getAppUpIdentifier(), 'string'));
        }
        if($request->getPreConsumeNotifyUrl() != null){
            $internalRequest->addParameter('preConsumeNotifyUrl', ObjectSerializer::sanitizeForSerialization($request->getPreConsumeNotifyUrl(), 'string'));
        }
...
PrePayV10RequestMarshaller::__init();
