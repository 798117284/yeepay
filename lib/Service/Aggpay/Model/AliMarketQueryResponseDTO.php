...
/**
 * AliMarketQueryResponseDTO Class Doc Comment
 *
 * @category Class
 * @description 响应结果
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AliMarketQueryResponseDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AliMarketQueryResponseDTO';
     ...
     *
     * @param string $channelInfoList 营销内容列表花呗支付渠道信息、银行卡渠道优惠信息等JSON格式
     *
     * @return $this
     */
