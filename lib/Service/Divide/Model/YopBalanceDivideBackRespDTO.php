...
/**
 * YopBalanceDivideBackRespDTO Class Doc Comment
 *
 * @category Class
 * @description 分账退回
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class YopBalanceDivideBackRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'YopBalanceDivideBackRespDTO';
     ...
     * Sets bankAccountNo
     *
     * @param string $bankAccountNo <p>原来的分账接收方的钱分账退回到此账户，<br />同原分账的出资方银行账户号</p>
     *
     * @return $this
     */
     ...
     * Sets accountType
     *
     * @param string $accountType <p>账户类型，同分账入参账户类型</p>
     *
     * @return $this
     */
