...
/**
 * YopBookTransferUpQueryReqDTO Class Doc Comment
 *
 * @category Class
 * @description 记账簿上划结果查询入参
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class YopBookTransferUpQueryReqDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'YopBookTransferUpQueryReqDTO';
