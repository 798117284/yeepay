...
/**
 * OverseasCardPayResultResponseDTO Class Doc Comment
 *
 * @category Class
 * @description 响应结果
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OverseasCardPayResultResponseDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OverseasCardPayResultResponseDTO';
     ...
     * Sets status
     *
     * @param string $status PROCESSING—支付中<br>SUCCESS–交易成功<br>FAIL—支付失败<br>WAIT_CONFIRM—待风控验证
     *
     * @return $this
     */
     ...
     *
     * @param string $bankPaySuccessDate 
     *
     * @return $this
     */
     ...
     *
     * @param string $riskValidateUrl 订单状态为待确认时需解析该字段
     *
     * @return $this
     */
