...
/**
 * OverseasCardPayResponseDTO Class Doc Comment
 *
 * @category Class
 * @description 响应结果
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OverseasCardPayResponseDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OverseasCardPayResponseDTO';
     ...
     * Sets status
     *
     * @param string $status FAIL:支付失败<br>WAIT_CONFIRM:待确认<br>PROCESSING:处理中<br>SUCCESS:交易成功（已经支付成功重复请求的时候，可能出现）
     *
     * @return $this
     */
     ...
     *
     * @param string $riskValidateUrl 当订单状态为WAIT_CONFIRM时，需解析此参数
     *
     * @return $this
     */
