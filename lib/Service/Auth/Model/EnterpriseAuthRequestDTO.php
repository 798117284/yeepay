...
/**
 * EnterpriseAuthRequestDTO Class Doc Comment
 *
 * @category Class
 * @description 企业信息认证入参
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EnterpriseAuthRequestDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EnterpriseAuthRequestDTO';
     ...
     * Sets regNo
     *
     * @param string $regNo <p>支持社会统一信用代码中、注册号任意一项</p> <p>企业名称和工商注册号最少填一个</p>
     *
     * @return $this
     */
     ...
     * Sets corpName
     *
     * @param string $corpName <p>企业名称全称</p> <p>企业名称全称和工商注册号最少填一个</p>
     *
     * @return $this
     */
     ...
     *
     * @param string $parentMerchantNo <p>父商编</p>
     *
     * @return $this
     */
