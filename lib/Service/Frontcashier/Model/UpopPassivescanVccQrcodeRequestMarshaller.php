...
class UpopPassivescanVccQrcodeRequestMarshaller implements RequestMarshaller
{
    /**
     * @var UpopPassivescanVccQrcodeRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new UpopPassivescanVccQrcodeRequestMarshaller();
    }

    /**
     * @return UpopPassivescanVccQrcodeRequestMarshaller
     */
    ...
    /**
     * @param UpopPassivescanVccQrcodeRequest $request
     * @return Request
     */
...
UpopPassivescanVccQrcodeRequestMarshaller::__init();
