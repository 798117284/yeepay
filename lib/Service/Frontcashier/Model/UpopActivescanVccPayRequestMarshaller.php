...
class UpopActivescanVccPayRequestMarshaller implements RequestMarshaller
{
    /**
     * @var UpopActivescanVccPayRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new UpopActivescanVccPayRequestMarshaller();
    }

    /**
     * @return UpopActivescanVccPayRequestMarshaller
     */
    ...
    /**
     * @param UpopActivescanVccPayRequest $request
     * @return Request
     */
...
UpopActivescanVccPayRequestMarshaller::__init();
