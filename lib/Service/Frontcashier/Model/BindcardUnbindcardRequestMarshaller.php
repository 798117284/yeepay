...
class BindcardUnbindcardRequestMarshaller implements RequestMarshaller
{
    ...
    public function marshal($request)
    {
        ...
        if($request->getBankCardNoFirst6() != null){
            $internalRequest->addParameter('bankCardNoFirst6', ObjectSerializer::sanitizeForSerialization($request->getBankCardNoFirst6(), 'string'));
        }
        if($request->getBankCardNoLast4() != null){
            $internalRequest->addParameter('bankCardNoLast4', ObjectSerializer::sanitizeForSerialization($request->getBankCardNoLast4(), 'string'));
        }
