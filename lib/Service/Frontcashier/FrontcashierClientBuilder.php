...
class FrontcashierClientBuilder
{
    ...
    public static function __init()
    {
        ...
        self::$authorizationReqRegistry->register('accountConfirm', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        self::$authorizationReqRegistry->register('accountInfoConfirm', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        ...
        self::$authorizationReqRegistry->register('bankTransferPayV1_1', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        self::$authorizationReqRegistry->register('bankTransferQuery', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        self::$authorizationReqRegistry->register('bank_transfer_pay_v1_1', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        self::$authorizationReqRegistry->register('bindcardBindcardlist', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        ...
        self::$authorizationReqRegistry->register('bindcardRequestV2_2', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        self::$authorizationReqRegistry->register('bindcardResendsms', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        ...
        self::$authorizationReqRegistry->register('bindcard_request_v2_2', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        ...
        self::$authorizationReqRegistry->register('upopActivescanVccPay', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        self::$authorizationReqRegistry->register('upopPassivescanBindQrcode', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        ...
        self::$authorizationReqRegistry->register('upopPassivescanVccQrcode', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        self::$authorizationReqRegistry->register('upop_activescan_vcc', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        self::$authorizationReqRegistry->register('upop_passivescan_vcc', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
