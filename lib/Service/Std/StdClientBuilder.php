...
class StdClientBuilder
{
    ...
    public static function __init()
    {
        ...
        self::$authorizationReqRegistry->register('billBillDownload', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        self::$authorizationReqRegistry->register('billDivideReceiverDownload', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        ...
        self::$authorizationReqRegistry->register('bill_divide_receiver_download', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        self::$authorizationReqRegistry->register('bill_fundbill_apply_v1_0', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        self::$authorizationReqRegistry->register('bill_fundbill_flow_query_v1_0', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        self::$authorizationReqRegistry->register('bill_fundbill_flow_sum_v1_0', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        ...
        self::$authorizationReqRegistry->register('orca_bill_download', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        self::$authorizationReqRegistry->register('voucherAssetApply', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        self::$authorizationReqRegistry->register('voucherDownload', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
    }
