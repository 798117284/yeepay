...
class YopQueryOrderInfoRespDTO implements ModelInterface, ArrayAccess
{
     ...
     * Sets payWay
     *
     * @param string $payWay <div data-page-id=\"TKcSdEsC1oFw1qx9zQ5czAf1nyc\" data-docx-has-block-data=\"false\"> <div class=\"ace-line ace-line old-record-id-A7NhddEdgoRaghx3YUTcmMW6nVe\"> <div data-lark-html-role=\"root\"><span class=\"text-only\" data-eleid=\"3\"><span class=\"text-only text-with-abbreviation text-with-abbreviation-bottomline\">POS</span>：内卡刷卡</span> <span class=\"text-only\" data-eleid=\"5\">MERCHANT_SCAN：被扫</span> <span class=\"text-only\" data-eleid=\"7\">USER_SCAN：主扫</span> <span class=\"text-only\" data-eleid=\"9\">OVERSEASCARDPAY：外卡刷卡</span> <span class=\"text-only\" data-eleid=\"11\">PREAUTH：预授权</span> <span class=\"text-only\" data-eleid=\"13\">PRECONSUME_MERCHANT_SCAN：预消费-被扫</span></div> </div> </div>
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status <p>订单状态</p> <div data-lark-html-role=\"root\"><span class=\"text-only\" data-eleid=\"3\">INIT：<span class=\"text-only text-with-abbreviation text-with-abbreviation-bottomline\">初始化</span>； PROCESS：处理中； SUCCESS：成功； TIMEOUT：超时； FAIL：失败； CLOSE：关闭</span></div>
     *
     * @return $this
     */
