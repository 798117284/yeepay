...
class InfoModifyV10RequestMarshaller implements RequestMarshaller
{
    /**
     * @var InfoModifyV10RequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new InfoModifyV10RequestMarshaller();
    }

    /**
     * @return InfoModifyV10RequestMarshaller
     */
    ...
    /**
     * @param InfoModifyV10Request $request
     * @return Request
     */
    public function marshal($request)
    {
        ...
        if(!empty($request->getInvoiceBusiness())){
            foreach ($request->getInvoiceBusiness() as $value){
                $internalRequest->addParameter('invoiceBusiness', ObjectSerializer::sanitizeForSerialization($value, 'string', 'string'));
            }
        }
...
InfoModifyV10RequestMarshaller::__init();
