...
class ConfigLimitAlertOperateRequestMarshaller implements RequestMarshaller
{
    /**
     * @var ConfigLimitAlertOperateRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new ConfigLimitAlertOperateRequestMarshaller();
    }

    /**
     * @return ConfigLimitAlertOperateRequestMarshaller
     */
    ...
    /**
     * @param ConfigLimitAlertOperateRequest $request
     * @return Request
     */
...
ConfigLimitAlertOperateRequestMarshaller::__init();
