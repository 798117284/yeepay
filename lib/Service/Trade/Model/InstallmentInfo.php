...
/**
 * InstallmentInfo Class Doc Comment
 *
 * @category Class
 * @description 信用卡分期信息
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InstallmentInfo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InstallmentInfo';
     ...
     * Sets instNumber
     *
     * @param string $instNumber <p>信用卡分期期数</p>
     *
     * @return $this
     */
