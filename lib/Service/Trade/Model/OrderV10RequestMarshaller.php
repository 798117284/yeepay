...
class OrderV10RequestMarshaller implements RequestMarshaller
{
    /**
     * @var OrderV10RequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new OrderV10RequestMarshaller();
    }

    /**
     * @return OrderV10RequestMarshaller
     */
    ...
    public function marshal($request)
    {
        ...
        if($request->getPreAuthNotifyUrl() != null){
            $internalRequest->addParameter('preAuthNotifyUrl', ObjectSerializer::sanitizeForSerialization($request->getPreAuthNotifyUrl(), 'string', 'notify-url'));
        }
...
OrderV10RequestMarshaller::__init();
