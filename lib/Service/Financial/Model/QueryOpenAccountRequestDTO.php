...
/**
 * QueryOpenAccountRequestDTO Class Doc Comment
 *
 * @category Class
 * @description 开户申请查询请求参数
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class QueryOpenAccountRequestDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'QueryOpenAccountRequestDTO';
